!(function (t, e) {
  ...
  (function (t, e) {
        ...
        return (
          ...
          (t.pause = function (t) {
            t || (this._isPaused = !0),
              this._element.querySelector(
                ".online-classes-item-next, .online-classes-item-prev"
          ...
          (t._addEventListeners = function () {
            ...
            this._config.keyboard &&
              p(this._element).on("keydown.bs.online-classes", function (t) {
                return e._keydown(t);
              }),
              "hover" === this._config.pause &&
                p(this._element)
                  .on("mouseenter.bs.online-classes", function (t) {
                    return e.pause(t);
                  })
                  .on("mouseleave.bs.online-classes", function (t) {
                    return e.cycle(t);
                  }),
          ...
          (t._addTouchEventListeners = function () {
            ...
            this._touchSupported &&
              ...
              p(this._element.querySelectorAll(".online-classes-item img")).on(
                "dragstart.bs.online-classes",
                function (t) {
                  return t.preventDefault();
                }
              ),
              this._pointerEvent
                ? (p(this._element).on("pointerdown.bs.online-classes", t),
                  p(this._element).on("pointerup.bs.online-classes", e),
                  this._element.classList.add("pointer-event"))
                : (p(this._element).on("touchstart.bs.online-classes", t),
                  p(this._element).on("touchmove.bs.online-classes", function (
                    t
                  ) {
                    var e;
                  ...
                  p(this._element).on("touchend.bs.online-classes", e)));
          }),
          ...
          (t._getItemIndex = function (t) {
            return (
              (this._items =
                t && t.parentNode
                  ? [].slice.call(
                      t.parentNode.querySelectorAll(".online-classes-item")
                    )
                  : []),
          ...
          (t._triggerSlideEvent = function (t, e) {
            var i = this._getItemIndex(t),
              ...
              r = p.Event("slide.bs.online-classes", {
                relatedTarget: t,
                direction: e,
                from: n,
                to: i,
          ...
          (t._slide = function (t, e) {
            var i,
              ...
              f =
                t === E
                  ? ((i = "online-classes-item-left"),
                    (n = "online-classes-item-next"),
                    "left")
                  : ((i = "online-classes-item-right"),
                    (n = "online-classes-item-prev"),
                    "right");
            u && p(u).hasClass(N)
              ? (this._isSliding = !1)
    ...
    p(document).on(
      "click.bs.online-classes.data-api",
      "[data-slide], [data-slide-to]",
      R._dataApiClickHandler
    ),
      p(window).on("load.bs.online-classes.data-api", function () {
        for (
          var t = [].slice.call(
              document.querySelectorAll('[data-ride="online-classes"]')
            ),
            e = 0,
            i = t.length;
          e < i;
  ...
  (function (l, i, r, a) {
    ...
    (h.Defaults = {
      ...
      (l.fn.owlCarousel = function (e) {
        ...
        return this.each(function () {
          var t = l(this),
            i = t.data("owl.online-classes");
          i ||
            ((i = new h(this, "object" == typeof e && e)),
            t.data("owl.online-classes", i),
            l.each(
              [
                "next",
                "prev",
