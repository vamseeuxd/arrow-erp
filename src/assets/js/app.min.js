!(function (t, e) {
  ...
  (S.fn = S.prototype = {
    ...
    (S.extend = S.fn.extend = function () {
      var t,
        ...
        h = !1;
      for (
        "boolean" == typeof o && ((h = o), (o = arguments[a] || {}), a++),
        ...
        if (null != (t = arguments[a]))
          for (e in t)
            (n = t[e]),
              "__proto__" !== e &&
                o !== n &&
                (h && n && (S.isPlainObject(n) || (r = Array.isArray(n)))
                  ? ((i = o[e]),
                    (s =
                      r && !Array.isArray(i)
                        ? []
  ...
  var f = (function (i) {
    ...
    try {
      P.apply((e = L.call(_.childNodes)), _.childNodes),
      ...
      if (!n && (x(t), (t = t || C), T)) {
        if (11 !== d && (l = et.exec(e)))
          if ((r = l[1])) {
            ...
            } else if (c && (o = c.getElementById(r)) && y(t, o) && o.id === r)
              return i.push(o), i;
          } else {
        ...
        if (
          ...
          if (((u = e), (c = t), 1 === d && (U.test(e) || V.test(e)))) {
            for (
              ((c = (it.test(e) && gt(t.parentNode)) || t) === t && f.scope) ||
                ((a = t.getAttribute("id"))
                  ? (a = a.replace(rt, st))
          ...
          try {
            return P.apply(i, c.querySelectorAll(u)), i;
          } catch (t) {
            N(e, !0);
          } finally {
      ...
      return (
        n != C &&
          ...
          (f.getById = ut(function (t) {
            return (
              (a.appendChild(t).id = S),
              !C.getElementsByName || !C.getElementsByName(S).length
            );
          })),
          f.getById
            ? ((w.filter.ID = function (t) {
                var e = t.replace(nt, c);
                return function (t) {
          ...
          (O = e
            ...
            : function (t, e) {
                ...
                for (; o[n] === a[n]; ) n++;
                return n ? dt(o[n], a[n]) : o[n] == _ ? -1 : a[n] == _ ? 1 : 0;
              })),
        C
      );
    }),
    ...
    (at.attr = function (t, e) {
      ...
      var i = w.attrHandle[e.toLowerCase()],
        n = i && A.call(w.attrHandle, e.toLowerCase()) ? i(t, e, !T) : void 0;
      return void 0 !== n
        ? n
        : f.attributes || !T
        ? t.getAttribute(e)
    ...
    ((w = at.selectors = {
      ...
      preFilter: {
        ATTR: function (t) {
          return (
            (t[1] = t[1].replace(nt, c)),
            (t[3] = (t[3] || t[4] || t[5] || "").replace(nt, c)),
            "~=" === t[2] && (t[3] = " " + t[3] + " "),
            t.slice(0, 4)
          );
        },
      ...
      filter: {
        TAG: function (t) {
          var e = t.replace(nt, c).toLowerCase();
          return "*" === t
            ? function () {
                return !0;
              }
                ...
                if (u) {
                  if (v) {
                    for (; h; ) {
                      for (o = t; (o = o[h]); )
                        if (
                          _ ? o.nodeName.toLowerCase() === c : 1 === o.nodeType
                        )
                          return !1;
                  ...
                  if (((l = [y ? u.firstChild : u.lastChild]), y && d)) {
                    for (
                      f =
                        (a =
                          (n =
                            (r =
                              (s = (o = u)[S] || (o[S] = {}))[o.uniqueID] ||
                              (s[o.uniqueID] = {}))[p] || [])[0] === k &&
                          n[1]) && n[2],
                        o = a && u.childNodes[a];
                      (o = (++a && o && o[h]) || (f = a = 0) || l.pop());
                    ...
                    (d &&
                      (f = a =
                        (n =
                          (r =
                            (s = (o = t)[S] || (o[S] = {}))[o.uniqueID] ||
                            (s[o.uniqueID] = {}))[p] || [])[0] === k && n[1]),
                    !1 === f)
                  )
                    for (
                      ;
            ...
            if (i) {
              ...
              for (; (t = t[l]); )
                if (1 === t.nodeType || c)
                  if (
                    ((r =
                      (s = t[S] || (t[S] = {}))[t.uniqueID] ||
                      (s[t.uniqueID] = {})),
                    h && h === t.nodeName.toLowerCase())
                  )
                    t = t[l] || t;
                  else {
                    if ((n = r[u]) && n[0] === k && n[1] === d)
                      return (o[2] = n[2]);
                    if (((r[u] = o)[2] = a(t, e, i))) return !0;
                  }
            return !1;
          };
    }
    ...
    function wt(t, e, i, n, r) {
      for (var s, o = [], a = 0, l = t.length, h = null != e; a < l; a++)
        (s = t[a]) && ((i && !i(s, n, r)) || (o.push(s), h && e.push(a)));
      return o;
    }
      ...
      return (
        ...
        ht(function (t, e, i, n) {
          var r,
            ...
            c = !f || (!t && p) ? u : wt(u, a, f, i, n),
            d = g ? (v || (t ? f : h || m) ? [] : e) : c;
          if ((g && g(c, d, i, n), m))
            for (r = wt(d, l), m(r, [], i, n), s = r.length; s--; )
              (o = r[s]) && (d[l[s]] = !(c[l[s]] = o));
          if (t) {
            if (v || f) {
              if (v) {
          ...
          } else (d = wt(d === e ? d.splice(h, d.length) : d)), v ? v(null, e, d, n) : P.apply(e, d);
        })
      );
    }
    function xt(m, v) {
      function t(t, e, i, n, r) {
        var s,
          ...
          g = f.length;
        for (r && (b = e == C || e || r); h !== g && null != (s = f[h]); h++) {
          if (_ && s) {
            for (
              o = 0, e || s.ownerDocument == C || (x(s), (i = !T));
              (a = m[o++]);
        ...
        if (((l += h), y && h !== l)) {
          for (o = 0; (a = v[o++]); ) a(u, c, e, i);
          if (t) {
            if (0 < l) for (; h--; ) u[h] || c[h] || (c[h] = R.call(n));
            c = wt(c);
          }
          P.apply(n, c),
            r && !t && 0 < c.length && 1 < l + v.length && at.uniqueSort(n);
        }
        return r && ((k = p), (b = d)), u;
      }
      var y = 0 < v.length,
    ...
    return (
      ...
      (p = at.tokenize = function (t, e) {
        ...
        for (o = t, a = [], l = w.preFilter; o; ) {
          for (s in ((i && !(n = B.exec(o))) ||
            (n && (o = o.slice(n[0].length) || o), a.push((r = []))),
          (i = !1),
          (n = V.exec(o)) &&
            ((i = n.shift()),
            r.push({ value: i, type: n[0].replace($, " ") }),
            (o = o.slice(i.length))),
          w.filter))
            !(n = X[s].exec(o)) ||
              (l[s] && !(n = l[s](n))) ||
        ...
        return e ? o.length : o ? at.error(t) : D(t, a).slice(0);
      }),
          ...
          for (i = (e = e || p(t)).length; i--; )
            (s = (function t(e) {
              for (
                ...
                if ((i = w.relative[e[l].type])) c = [yt(_t(c), i)];
                else {
                  if ((i = w.filter[e[l].type].apply(null, e[l].matches))[S]) {
                    for (n = ++l; n < s && !w.relative[e[n].type]; n++);
                    return bt(
                      1 < l && _t(c),
                      1 < l &&
                        vt(
      ...
      (g = at.select = function (t, e, i, n) {
        ...
        if (((i = i || []), 1 === u.length)) {
          if (
            ...
            if (!(e = (w.find.ID(o.matches[0].replace(nt, c), e) || [])[0]))
              return i;
            h && (e = e.parentNode), (t = t.slice(s.shift().value.length));
          }
          for (
            r = X.needsContext.test(t) ? 0 : s.length;
            ...
            if (
              (l = w.find[a]) &&
              (n = l(
                o.matches[0].replace(nt, c),
                (it.test(s[0].type) && gt(e.parentNode)) || e
              ))
            ) {
              if ((s.splice(r, 1), !(t = n.length && vt(s))))
  ...
  (S.filter = function (t, e, i) {
    ...
    S.fn.extend({
      ...
      is: function (t) {
        return !!M(this, "string" == typeof t && k.test(t) ? S(t) : t || [], !1)
          .length;
      },
    });
  var N,
  ...
  ((S.fn.init = function (t, e, i) {
    ...
    if (n[1]) {
      if (
        ...
        S.merge(
          this,
          S.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : T, !0)
        ),
    ...
    return (
      (r = T.getElementById(n[2])) && ((this[0] = r), (this.length = 1)), this
    );
  }).prototype = S.fn),
    (N = S(T));
      ...
      function (n, r) {
        S.fn[n] = function (t, e) {
          ...
          return (
            ...
            1 < this.length &&
              (R[n] || S.uniqueSort(i), A.test(n) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  (S.Callbacks = function (n) {
    ...
    n =
      "string" == typeof n
        ? ((t = n),
          (i = {}),
          S.each(t.match(P) || [], function (t, e) {
            i[e] = !0;
          }),
          i)
        : S.extend({}, n);
    function r() {
      for (a = a || n.once, o = s = !0; h.length; u = -1)
    ...
    var s,
      ...
      c = {
        add: function () {
          return (
            l &&
              (e && !s && ((u = l.length - 1), h.push(e)),
              (function i(t) {
                S.each(t, function (t, e) {
                  _(e)
                    ? (n.unique && c.has(e)) || l.push(e)
                    : e && e.length && "string" !== b(e) && i(e);
                });
              })(arguments),
              e && !s && r()),
            this
    ...
    S.extend({
          ...
          o = {
            ...
            then: function (e, i, n) {
                  ...
                  function t() {
                    ...
                    if (!(r < l)) {
                      ...
                      (e =
                        ...
                        _(e)
                          ? a
                            ? e.call(t, h(l, s, L, a), h(l, s, H, a))
                            : (l++,
                              e.call(
                                t,
                                h(l, s, L, a),
                                h(l, s, H, a),
                                h(l, s, L, s.notifyWith)
                              ))
                          : (o !== L && ((i = void 0), (n = [t])),
                            (a || s.resolveWith)(i, n));
                    }
              ...
              return S.Deferred(function (t) {
                s[0][3].add(h(0, t, _(n) ? n : L, t.notifyWith)),
                  s[1][3].add(h(0, t, _(e) ? e : L)),
                  s[2][3].add(h(0, t, _(i) ? i : H));
              }).promise();
            },
            promise: function (t) {
      ...
      when: function (t) {
        ...
        if (
          i <= 1 &&
          (I(t, o.done(e(n)).resolve, o.reject, !i),
          "pending" === o.state() || _(s[n] && s[n].then))
        )
          return o.then();
        for (; n--; ) I(s[n], e(n), o.reject);
        return o.promise();
      },
    });
  ...
  var F = function (t, e, i, n, r, s, o) {
      var a = 0,
        l = t.length,
        h = null == i;
      if ("object" === b(i))
        for (a in ((r = !0), i)) F(t, e, a, i[a], !0, s, o);
      else if (
        void 0 !== n &&
        ((r = !0),
        _(n) || (o = !0),
  ...
  function V(t) {
    return t.replace(z, "ms-").replace($, B);
  }
  function U(t) {
  ...
  S.extend({
    ...
    S.fn.extend({
      data: function (i, t) {
          ...
          return "object" == typeof i
            ...
            : F(
                ...
                function (t) {
                  var e;
                  return s && void 0 === t
                    ? void 0 !== (e = X.get(s, i)) || void 0 !== (e = J(s, i))
                      ? e
                      : void 0
        ...
        if (
          this.length &&
          ((r = X.get(s)), 1 === s.nodeType && !Q.get(s, "hasDataAttrs"))
        ) {
          for (e = o.length; e--; )
            o[e] &&
              0 === (n = o[e].name).indexOf("data-") &&
              ((n = V(n.slice(5))), J(s, n, r[n]));
  ...
  var ot = function (t, e) {
    return (
      ...
      ("" === t.style.display && rt(t) && "none" === S.css(t, "display"))
    );
  };
  function at(t, e, i, n) {
    var r,
      ...
      u =
        ...
        et.exec(S.css(t, e));
    if (u && u[3] !== h) {
      for (l /= 2, h = h || u[3], u = +l || 1; o--; )
        S.style(t, e, u + h),
          (1 - s) * (1 - (s = a() / l || 0.5)) <= 0 && (o = 0),
          (u /= s);
      (u *= 2), S.style(t, e, u + h), (i = i || []);
    }
    return (
      i &&
        ((u = +u || +l || 0),
  ...
  var lt = {};
  function ht(t, e) {
    for (var i, n, r, s, o, a, l, h = [], u = 0, c = t.length; u < c; u++)
      (n = t[u]).style &&
        ((i = n.style.display),
        e
          ? ("none" === i &&
              ((h[u] = Q.get(n, "display") || null),
              h[u] || (n.style.display = "")),
            "" === n.style.display &&
              ot(n) &&
              (h[u] =
                ...
                (l = lt[a]) ||
                  ...
                  "none" === l && (l = "block"),
                  (lt[a] = l)))))
          : "none" !== i && ((h[u] = "none"), Q.set(n, "display", i)));
  ...
  (ut = T.createDocumentFragment().appendChild(T.createElement("div"))),
    (ct = T.createElement("input")).setAttribute("type", "radio"),
    ct.setAttribute("checked", "checked"),
    ct.setAttribute("name", "t"),
    ut.appendChild(ct),
    (y.checkClone = ut.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (ut.innerHTML = "<textarea>x</textarea>"),
    (y.noCloneChecked = !!ut.cloneNode(!0).lastChild.defaultValue),
    (ut.innerHTML = "<option></option>"),
    (y.option = !!ut.lastChild);
  var gt = {
    thead: [1, "<table>", "</table>"],
  ...
  function _t(t, e, i, n, r) {
    ...
    for (c.textContent = "", f = 0; (s = d[f++]); )
      if (n && -1 < S.inArray(s, n)) r && r.push(s);
        ...
        ((h = rt(s)), (o = mt(c.appendChild(s), "script")), h && vt(o), i)
      )
        for (u = 0; (s = o[u++]); ) pt.test(s.type || "") && i.push(s);
    return c;
  }
  var wt = /^key/,
  ...
  function Et(t, r, s) {
    s
        ...
        S.event.add(t, r, {
          ...
          handler: function (t) {
            ...
            if (1 & t.isTrigger && this[r]) {
              if (n.length)
                (S.event.special[r] || {}).delegateType && t.stopPropagation();
              else if (
                ((n = a.call(arguments)),
                Q.set(this, r, n),
                (e = s(this, r)),
                this[r](),
                n !== (i = Q.get(this, r)) || e ? Q.set(this, r, !1) : (i = {}),
                n !== i)
              )
                return (
      ...
      : void 0 === Q.get(t, r) && S.event.add(t, r, Ct);
  }
  (S.event = {
    global: {},
          ...
          (f = g = (a = xt.exec(t[h]) || [])[1]),
            ...
            f &&
              ...
              (d = l[f]) ||
                ...
                (c.setup && !1 !== c.setup.call(e, n, p, o)) ||
      ...
      if (m && (l = m.events)) {
        for (h = (e = (e || "").match(P) || [""]).length; h--; )
          if (
            ...
            for (
              c = S.event.special[f] || {},
                d = l[(f = (n ? c.delegateType : c.bindType) || f)] || [],
                a =
                  a[2] &&
                  new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                o = s = d.length;
            ...
            o &&
              ...
              delete l[f]);
          } else for (f in l) S.event.remove(t, f + e[h], i, n, !0);
    ...
    dispatch: function (t) {
      ...
      if (
        ...
        for (
          o = S.event.handlers.call(this, l, h), e = 0;
    ...
    special: {
      ...
      click: {
        setup: function (t) {
          var e = this || t;
          return (
            dt.test(e.type) && e.click && E(e, "input") && Et(e, "click", Ct),
            !1
          );
        },
        trigger: function (t) {
          var e = this || t;
          return (
            dt.test(e.type) && e.click && E(e, "input") && Et(e, "click"), !0
          );
        },
        _default: function (t) {
          var e = t.target;
    ...
    if (1 === e.nodeType) {
      if (Q.hasData(t) && (a = Q.get(t).events))
        for (r in (Q.remove(e, "handle events"), a))
          for (i = 0, n = a[r].length; i < n; i++) S.event.add(e, r, a[r][i]);
      X.hasData(t) && ((s = X.access(t)), (o = S.extend({}, s)), X.set(e, o));
    }
  }
  function Pt(i, n, r, s) {
    n = m(n);
    var t,
      ...
      f = n[0],
      p = _(f);
    if (p || (1 < c && "string" == typeof f && !y.checkClone && Mt.test(f)))
      return i.each(function (t) {
        var e = i.eq(t);
        p && (n[0] = f.call(this, t, e.html())), Pt(e, n, r, s);
      });
    if (
      c &&
      ...
      for (a = (o = S.map(mt(t, "script"), At)).length; u < c; u++)
        (l = t),
          u !== d &&
            ((l = S.clone(l, !0, !0)), a && S.merge(o, mt(l, "script"))),
          r.call(i[u], l, u);
      if (a)
        for (h = o[o.length - 1].ownerDocument, S.map(o, Rt), u = 0; u < a; u++)
          (l = o[u]),
            pt.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : w(l.textContent.replace(Nt, ""), l, h));
    }
    return i;
  }
  function Lt(t, e, i) {
    for (var n, r = e ? S.filter(e, t) : t, s = 0; null != (n = r[s]); s++)
  ...
  S.extend({
    ...
    clone: function (t, e, i) {
      ...
      if (
        ...
        for (o = mt(u), n = 0, r = (s = mt(t)).length; n < r; n++)
          (a = s[n]),
            (l = o[n]),
            "input" === (h = l.nodeName.toLowerCase()) && dt.test(a.type)
              ? (l.checked = a.checked)
              : ("input" !== h && "textarea" !== h) ||
                (l.defaultValue = a.defaultValue);
      if (e)
        if (i)
          for (s = s || mt(t), o = o || mt(u), n = 0, r = s.length; n < r; n++)
            jt(s[n], o[n]);
        else jt(t, u);
      return (
        0 < (o = mt(u, "script")).length && vt(o, !c && mt(t, "script")), u
      );
    },
      ...
      for (var e, i, n, r = S.event.special, s = 0; void 0 !== (i = t[s]); s++)
        if (U(i)) {
          if ((e = i[Q.expando])) {
            if (e.events)
              for (n in e.events)
                r[n] ? S.event.remove(i, n) : S.removeEvent(i, n, e.handle);
            i[Q.expando] = void 0;
          }
      ...
      prepend: function () {
        return Pt(this, arguments, function (t) {
          ...
          (1 !== this.nodeType &&
            11 !== this.nodeType &&
            9 !== this.nodeType) ||
            (e = Ot(this, t)).insertBefore(t, e.firstChild);
        });
      },
      before: function () {
        return Pt(this, arguments, function (t) {
      ...
      replaceWith: function () {
        ...
        return Pt(
          ...
          function (t) {
            ...
            S.inArray(this, i) < 0 &&
              (S.cleanData(mt(this)), e && e.replaceChild(t, this));
          },
          i
        );
      },
    ...
    S.each(
      ...
      function (t, o) {
        S.fn[t] = function (t) {
          for (var e, i = [], n = S(t), r = n.length - 1, s = 0; s <= r; s++)
  ...
  function Qt() {
    ...
    Bt &&
      ...
      nt.appendChild($t).appendChild(Bt),
      (t = C.getComputedStyle(Bt)),
      (It = "1%" !== t.top),
      (zt = 12 === Xt(t.marginLeft)),
      (Bt.style.right = "60%"),
      (qt = 36 === Xt(t.right)),
      (Wt = 36 === Xt(t.width)),
      (Bt.style.position = "absolute"),
      (Yt = 12 === Xt(Bt.offsetWidth / 3)),
      nt.removeChild($t),
      (Bt = null));
  }
  function Xt(t) {
    ...
    return (
      ...
      (t in te
        ...
        : (ee[t] =
            (function (t) {
              for (
                var e = t[0].toUpperCase() + t.slice(1), i = Jt.length;
                i--;
  ...
  function le(t, e, i, n, r, s) {
    ...
    for (; o < 4; o += 2)
      "margin" === i && (l += S.css(t, i + it[o], !0, r)),
        n
          ? ("content" === i && (l -= S.css(t, "padding" + it[o], !0, r)),
            "margin" !== i &&
              (l -= S.css(t, "border" + it[o] + "Width", !0, r)))
          : ((l += S.css(t, "padding" + it[o], !0, r)),
            "padding" !== i
              ? (l += S.css(t, "border" + it[o] + "Width", !0, r))
              : (a += S.css(t, "border" + it[o] + "Width", !0, r)));
    return (
      !n &&
        0 <= s &&
        (l +=
  ...
  function he(t, e, i) {
    ...
    return (
      ((!y.boxSizingReliable() && r) ||
        ...
        "auto" === o ||
        (!parseFloat(o) && "inline" === S.css(t, "display", !1, n))) &&
        t.getClientRects().length &&
        ((r = "border-box" === S.css(t, "boxSizing", !1, n)),
        (s = a in t) && (o = t[a])),
      (o = parseFloat(o) || 0) +
        le(t, e, i || (r ? "border" : "content"), s, n, o) +
        "px"
    );
  }
  function ue(t, e, i, n, r) {
    return new ue.prototype.init(t, e, i, n, r);
  }
  S.extend({
    cssHooks: {
      opacity: {
    ...
    style: function (t, e, i, n) {
      if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
        var r,
          ...
          h = t.style;
        if (
          (l || (e = ie(a)), (o = S.cssHooks[e] || S.cssHooks[a]), void 0 === i)
        )
          return o && "get" in o && void 0 !== (r = o.get(t, !1, n)) ? r : h[e];
        "string" === (s = typeof i) &&
          (r = et.exec(i)) &&
          r[1] &&
          ((i = at(t, e, r)), (s = "number")),
    ...
    S.each(["height", "width"], function (t, l) {
      S.cssHooks[l] = {
        get: function (t, e, i) {
          if (e)
            return !ne.test(S.css(t, "display")) ||
        ...
        set: function (t, e, i) {
          var n,
            ...
            o = (s || i) && "border-box" === S.css(t, "boxSizing", !1, r),
            a = i ? le(t, l, i, o, r) : 0;
          return (
            o &&
              s &&
      ...
      (S.cssHooks[r + s] = {
        expand: function (t) {
          for (
            ...
            i[r + it[e] + s] = n[e] || n[e - 2] || n[0];
          return i;
        },
      }),
        "margin" !== r && (S.cssHooks[r + s].set = ae);
    }),
    S.fn.extend({
      css: function (t, e) {
        return F(
          ...
          function (t, e, i) {
            var n,
              ...
              o = 0;
            if (Array.isArray(e)) {
              for (n = Ut(t), r = e.length; o < r; o++)
                s[e[o]] = S.css(t, e[o], !1, n);
              return s;
            }
      ...
      _default: {
        ...
        set: function (t) {
          S.fx.step[t.prop]
            ? S.fx.step[t.prop](t)
            : 1 !== t.elem.nodeType ||
              (!S.cssHooks[t.prop] && null == t.elem.style[ie(t.prop)])
            ? (t.elem[t.prop] = t.now)
  ...
  function be(s, t, e) {
    var i,
      ...
      l = function () {
        ...
        for (
          ...
          h.tweens[n].run(i);
        return (
          a.notifyWith(s, [h, i, e]),
          i < 1 && r
            ? e
            : (r || a.notifyWith(s, [h, 1, 0]), a.resolveWith(s, [h]), !1)
        );
      },
      h = a.promise({
        elem: s,
        ...
        stop: function (t) {
          ...
          return (
            t
              ? (a.notifyWith(s, [h, 1, 0]), a.resolveWith(s, [h, t]))
              : a.rejectWith(s, [h, t]),
            this
          );
        },
    ...
    for (
      ...
      if ((i = be.prefilters[n].call(h, s, u, h.opts)))
        return (
          _(i.stop) &&
    ...
    return (
      S.map(u, we, h),
      _(h.opts.start) && h.opts.start.call(s, h),
      h
        .progress(h.opts.progress)
        .done(h.opts.done, h.opts.complete)
        .fail(h.opts.fail)
        .always(h.opts.always),
      S.fx.timer(S.extend(l, { elem: s, anim: h, queue: h.opts.queue })),
      h
    );
  }
  (S.Animation = S.extend(be, {
    ...
    tweener: function (t, e) {
      for (
        var i, n = 0, r = (t = _(t) ? ((e = t), ["*"]) : t.match(P)).length;
        n < r;
        n++
      )
        (i = t[n]),
          (be.tweeners[i] = be.tweeners[i] || []),
          be.tweeners[i].unshift(e);
    },
    prefilters: [
      function (t, e, i) {
        var n,
        ...
        if ((l = !S.isEmptyObject(e)) || !S.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              g && ht([t], !0),
              d.done(function () {
                for (n in (g || ht([t]), Q.remove(t, "fxshow"), f))
                  S.style(t, n, f[n]);
              })),
              (l = we(g ? m[n] : 0, n, d)),
              n in m ||
    ...
    (S.speed = function (t, e, i) {
      ...
      return (
        ...
        (n.old = n.complete),
        (n.complete = function () {
          _(n.old) && n.old.call(this), n.queue && S.dequeue(this, n.queue);
        }),
        n
      );
    }),
      ...
      stop: function (r, t, s) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (e in n) n[e] && n[e].stop && me.test(e) && o(n[e]);
            for (e = i.length; e--; )
              i[e].elem !== this ||
                (null != r && i[e].queue !== r) ||
    ...
    (S.fx.tick = function () {
      var t,
        e = 0,
        i = S.timers;
      for (ce = Date.now(); e < i.length; e++)
        (t = i[e])() || i[e] !== t || i.splice(e--, 1);
      i.length || S.fx.stop(), (ce = void 0);
    }),
  ...
  S.fn.extend({
    ...
    S.fn.extend({
      addClass: function (e) {
        ...
        if ((t = De(e)).length)
          for (; (i = this[l++]); )
            if (((r = Ee(i)), (n = 1 === i.nodeType && " " + ke(r) + " "))) {
              for (o = 0; (s = t[o++]); )
                n.indexOf(" " + s + " ") < 0 && (n += s + " ");
              r !== (a = ke(n)) && i.setAttribute("class", a);
            }
        return this;
      },
      ...
      hasClass: function (t) {
        for (var e, i = 0, n = " " + t + " "; (e = this[i++]); )
          if (1 === e.nodeType && -1 < (" " + ke(Ee(e)) + " ").indexOf(n))
            return !0;
        return !1;
      },
    });
  ...
  S.fn.extend({
    val: function (i) {
      ...
      return arguments.length
        ...
        : e
        ? (n = S.valHooks[e.type] || S.valHooks[e.nodeName.toLowerCase()]) &&
          "get" in n &&
    ...
    S.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (t, e) {
            for (
              var i, n, r = t.options, s = S.makeArray(e), o = r.length;
              o--;
  ...
  S.extend(S.event, {
    trigger: function (t, e, i, n) {
      ...
      if (
        3 !== i.nodeType &&
        8 !== i.nodeType &&
        !Oe.test(d + S.event.triggered) &&
        (-1 < d.indexOf(".") && ((d = (f = d.split(".")).shift()), f.sort()),
        (a = d.indexOf(":") < 0 && "on" + d),
        ((t = t[S.expando]
          ? t
          : new S.Event(d, "object" == typeof t && t)).isTrigger = n ? 2 : 3),
        (t.namespace = f.join(".")),
        ...
        if (!n && !h.noBubble && !g(i)) {
          for (
            o = h.delegateType || d, Oe.test(o + d) || (p = p.parentNode);
            p;
            p = p.parentNode
          )
            c.push(p), (s = p);
          s === (i.ownerDocument || T) &&
            c.push(s.defaultView || s.parentWindow || C);
        }
        for (r = 0; (p = c[r++]) && !t.isPropagationStopped(); )
          (u = p),
            (t.type = 1 < r ? o : h.bindType || d),
            (l =
              (Q.get(p, "events") || Object.create(null))[t.type] &&
              Q.get(p, "handle")) && l.apply(p, e),
            (l = a && p[a]) &&
              l.apply &&
              U(p) &&
        ...
        return (
          ...
          n ||
            ...
            (h._default && !1 !== h._default.apply(c.pop(), e)) ||
            !U(i) ||
            (a &&
              _(i[d]) &&
              !g(i) &&
              ((s = i[a]) && (i[a] = null),
              (S.event.triggered = d),
              t.isPropagationStopped() && u.addEventListener(d, Ne),
              i[d](),
              t.isPropagationStopped() && u.removeEventListener(d, Ne),
    ...
    if (Array.isArray(t) || (t.jquery && !S.isPlainObject(t)))
      ...
      for (n in t)
        !(function i(n, t, r, s) {
          ...
          else if (r || "object" !== b(t)) s(n, t);
          else for (e in t) i(n + "[" + e + "]", t[e], r, s);
        })(n, t[n], e, i);
    return r.join("&");
  }),
    S.fn.extend({
    ...
    S.extend({
      ...
      ajax: function (t, e) {
        ...
        m.hasContent
          ...
          : ((s = m.url.slice(c.length)),
            m.data &&
              (m.processData || "string" == typeof m.data) &&
              ((c += (je.test(c) ? "&" : "?") + m.data), delete m.data),
            !1 === m.cache &&
              ((c = c.replace(qe, "$1")),
              (s = (je.test(c) ? "&" : "?") + "_=" + Re.guid++ + s)),
            (m.url = c + s)),
        m.ifModified &&
          (S.lastModified[c] &&
            ...
            r
              ? (m.ifModified &&
                  ((l = x.getResponseHeader("Last-Modified")) &&
                    (S.lastModified[c] = l),
                  (l = x.getResponseHeader("etag")) && (S.etag[c] = l)),
                204 === t || "HEAD" === m.type
                  ? (h = "nocontent")
                  : 304 === t
                  ? (h = "notmodified")
                  : ((h = a.state), (s = a.data), (r = !(o = a.error))))
              : ((o = h), (!t && h) || ((h = "error"), t < 0 && (t = 0))),
            (x.status = t),
            (x.statusText = (e || h) + ""),
            r ? _.resolveWith(v, [s, h, x]) : _.rejectWith(v, [x, h, o]),
            x.statusCode(b),
            (b = void 0),
            g && y.trigger(r ? "ajaxSuccess" : "ajaxError", [x, m, r ? s : o]),
            w.fireWith(v, [x, h]),
            g &&
  ...
  (y.cors = !!Je && "withCredentials" in Je),
    (y.ajax = Je = !!Je),
    S.ajaxTransport(function (r) {
      var s, o;
      if (y.cors || (Je && !r.crossDomain))
        return {
          send: function (t, e) {
            var i,
              n = r.xhr();
  ...
  S.ajaxSetup({
    ...
    jsonpCallback: function () {
      var t = ei.pop() || S.expando + "_" + Re.guid++;
      return (this[t] = !0), t;
    },
  }),
      ...
      if (o || "jsonp" === t.dataTypes[0])
        return (
          (n = t.jsonpCallback = _(t.jsonpCallback)
            ...
            : t.jsonpCallback),
          o
            ? (t[o] = t[o].replace(ii, "$1" + n))
            : !1 !== t.jsonp &&
              (t.url += (je.test(t.url) ? "&" : "?") + t.jsonp + "=" + n),
          ...
          i.always(function () {
            void 0 === r ? S(C).removeProp(n) : (C[n] = r),
              t[n] && ((t.jsonpCallback = e.jsonpCallback), ei.push(n)),
              s && _(r) && r(s[0]),
              (s = r = void 0);
          }),
          "script"
    ...
    (y.createHTMLDocument =
      (((ti = T.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    (S.parseHTML = function (t, e, i) {
      return "string" != typeof t
        ...
        : ("boolean" == typeof e && ((i = e), (e = !1)),
          e ||
            (y.createHTMLDocument
              ? (((n = (e = T.implementation.createHTMLDocument(
                  ""
    ...
    (S.fn.load = function (t, e, i) {
      var n,
        ...
        a = t.indexOf(" ");
      return (
        -1 < a && ((n = ke(t.slice(a))), (t = t.slice(0, a))),
        _(e)
          ? ((i = e), (e = void 0))
        ...
        0 < o.length &&
          S.ajax({ url: t, type: r || "GET", dataType: "html", data: e })
            .done(function (t) {
              (s = arguments),
                o.html(n ? S("<div>").append(S.parseHTML(t)).find(n) : t);
            })
            .always(
              i &&
                function (t, e) {
    ...
    (S.offset = {
      setOffset: function (t, e, i) {
        ...
        "static" === h && (t.style.position = "relative"),
          ...
          (l = S.css(t, "left")),
          (r =
            ("absolute" === h || "fixed" === h) && -1 < (s + l).indexOf("auto")
              ? ((o = (n = u.position()).top), n.left)
              : ((o = parseFloat(s) || 0), parseFloat(l) || 0)),
          _(e) && (e = e.call(t, i, S.extend({}, a))),
    ...
    S.each(["top", "left"], function (t, i) {
      S.cssHooks[i] = Kt(y.pixelPosition, function (t, e) {
        if (e)
          return (e = Zt(t, i)), Vt.test(e) ? S(t).position()[i] + "px" : e;
      });
    }),
    S.each({ Height: "height", Width: "width" }, function (o, a) {
      S.each({ padding: "inner" + o, content: a, "": "outer" + o }, function (
        n,
        s
      ) {
        S.fn[s] = function (t, e) {
  ...
  return (
    (S.noConflict = function (t) {
      return C.$ === S && (C.$ = si), t && C.jQuery === S && (C.jQuery = ri), S;
    }),
  ...
  (function (t, e) {
    ...
    function g(t) {
      ...
      var e = w(t),
        ...
        n = e.overflowX,
        r = e.overflowY;
      return /(auto|scroll|overlay)/.test(i + r + n) ? t : g(p(t));
    }
    function m(t) {
      return t && t.referenceNode ? t.referenceNode : t;
    }
    var e = i && !(!window.MSInputMethodContext || !document.documentMode),
      r = i && /MSIE 10/.test(navigator.userAgent);
    function v(t) {
      return 11 === t ? e : (10 !== t && e) || r;
    }
    function _(t) {
      if (!t) return document.documentElement;
      for (
        var e = v(10) ? document.body : null, i = t.offsetParent || null;
    ...
    function y(t, e) {
      ...
      if ((t !== l && e !== l) || n.contains(r))
        return "BODY" === (a = (o = l).nodeName) ||
          ("HTML" !== a && _(o.firstElementChild) !== o)
          ? _(l)
          : l;
      var h = u(t);
      return h.host ? y(h.host, e) : y(t, u(e).host);
    }
    function b(t, e) {
      var i =
    ...
    function E(t, e, i) {
      var n = 2 < arguments.length && void 0 !== i && i,
        ...
        c = parseFloat(h.borderLeftWidth);
        ...
        : ((s = void 0),
          ...
          (function t(e) {
            ...
            : ((l = (a = x(t.ownerDocument)).height),
              (h = a.width),
              (c.top += o.top - o.marginTop),
              (c.bottom = l + o.top),
              (c.left += o.left - o.marginLeft),
              (c.right = h + o.left)));
      var f = "number" == typeof (i = i || 0);
      return (
        (c.left += f ? i : i.left || 0),
        (c.top += f ? i : i.top || 0),
        (c.right -= f ? i : i.right || 0),
        (c.bottom -= f ? i : i.bottom || 0),
        c
      );
    }
    function d(t, e, n, i, r, s) {
      ...
      var a = f(n, i, o, r),
        ...
        h = Object.keys(l)
          .map(function (t) {
            return T({ key: t }, l[t], { area: (e = l[t]).width * e.height });
            var e;
          })
          .sort(function (t, e) {
    ...
    function j(t, i, e) {
      return (
        (void 0 === e
          ...
          t.enabled &&
            o(e) &&
            ((i.offsets.popper = S(i.offsets.popper)),
            (i.offsets.reference = S(i.offsets.reference)),
            (i = e(i, t)));
        }),
        i
      );
    ...
    function F(t, e) {
      ...
      var n = t.offsets,
        ...
        d = e ? (u || c || l % 2 == h % 2 ? o : a) : i,
        f = e ? o : i;
      return {
        left: d(l % 2 == 1 && h % 2 == 1 && !c && e ? r.left - 1 : r.left),
        top: f(r.top),
        bottom: f(r.bottom),
        right: d(r.right),
      };
    ...
    var K = {
        ...
        modifiers: {
            ...
            fn: function (t) {
              ...
              return (
                u &&
                  ...
                  (n = e.popper),
                  (o = (r = -1 !== ["bottom", "top"].indexOf(h))
                    ? "width"
                    : "height"),
                  (a = {
                    start: C({}, (s = r ? "left" : "top"), i[s]),
                    end: C({}, s, i[s] + i[o] - n[o]),
                  }),
                  (t.offsets.popper = T({}, n, a[u]))),
                t
              );
            },
          },
          ...
          preventOverflow: {
            ...
            enabled: !0,
            fn: function (t, n) {
              var e = n.boundariesElement || _(t.instance.popper);
          ...
          keepTogether: {
            ...
            fn: function (t) {
              var e = t.offsets,
                ...
                h = o ? "width" : "height";
              return (
                i[a] < s(n[l]) && (t.offsets.popper[l] = s(n[l]) - i[h]),
          ...
          arrow: {
            ...
            fn: function (t, e) {
              ...
              var r = t.placement.split("-")[0],
                ...
                f = l ? "bottom" : "right",
                p = N(n)[h];
              a[f] - p < o[c] && (t.offsets.popper[c] -= o[c] - (a[f] - p)),
                a[c] + p > o[f] && (t.offsets.popper[c] += a[c] + p - o[f]),
                (t.offsets.popper = S(t.offsets.popper));
              var g = a[c] + a[h] / 2 - p / 2,
                m = w(t.instance.popper),
                v = parseFloat(m["margin" + u]),
                y = parseFloat(m["border" + u + "Width"]),
                _ = g - t.offsets.popper[c] - v - y,
                _ = Math.max(Math.min(o[h] - p, _), 0);
              return (
                (t.arrowElement = n),
                (t.offsets.arrow =
                  (C((i = {}), c, Math.round(_)), C(i, d, ""), i)),
                t
              );
            },
            element: "[x-arrow]",
            ...
            fn: function (m, v) {
              ...
              return (
                x.forEach(function (t, e) {
                  if (_ !== t || x.length === e + 1) return m;
                  (_ = m.placement.split("-")[0]), (w = O(_));
                  var i,
                    n = m.offsets.popper,
                    r = m.offsets.reference,
                    s = Math.floor,
                    o =
                      ("left" === _ && s(n.right) > s(r.left)) ||
                      ("right" === _ && s(n.left) < s(r.right)) ||
                      ("top" === _ && s(n.bottom) > s(r.top)) ||
                      ("bottom" === _ && s(n.top) < s(r.bottom)),
                    a = s(n.left) < s(y.left),
                    l = s(n.right) > s(y.right),
                    h = s(n.top) < s(y.top),
                    u = s(n.bottom) > s(y.bottom),
                    c =
                      ("left" === _ && a) ||
                      ("right" === _ && l) ||
                      ("top" === _ && h) ||
                  ...
                  (o || c || g) &&
                    ...
                    (m.offsets.popper = T(
                      {},
                      m.offsets.popper,
                      A(m.instance.popper, m.offsets.reference, m.placement)
                    )),
          ...
          computeStyle: {
            ...
            fn: function (t, e) {
              ...
              var o,
                ...
                h = _(t.instance.popper),
                u = k(h),
                c = { position: r.position },
                d = F(t, window.devicePixelRatio < 2 || !z),
                ...
                v =
                  "bottom" == f
                    ? "HTML" === h.nodeName
                      ? -h.clientHeight + d.bottom
                      : -u.height + d.bottom
                    : d.top,
                m =
                  "right" == p
                    ? "HTML" === h.nodeName
                      ? -h.clientWidth + d.right
                      : -u.width + d.right
                    : d.left;
              l && g
                ? ((c[g] = "translate3d(" + m + "px, " + v + "px, 0)"),
                  (c[f] = 0),
                  (c[p] = 0),
    ...
    function tt(t, e) {
      ...
      l(this, tt),
        ...
        (this.options = T({}, tt.Defaults, n)),
        (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
        (this.reference = t && t.jquery ? t[0] : t),
        (this.popper = e && e.jquery ? e[0] : e),
        (this.options.modifiers = {}),
        Object.keys(T({}, tt.Defaults.modifiers, n.modifiers)).forEach(
          function (t) {
  ...
  (function (t, e) {
    ...
    p(document).on(
      ...
      (p.fn[s] = u._jQueryInterface),
      (p.fn[s].Constructor = u),
      (p.fn[s].noConflict = function () {
        return (p.fn[s] = h), u._jQueryInterface;
      });
    var d = "button",
      f = "bs.button",
      m = p.fn[d],
      ...
      w = (function () {
        ...
        return (
          (t.toggle = function () {
            ...
            !r ||
              ((t = this._element.querySelector(_)) &&
                ("radio" === t.type &&
                  (t.checked && this._element.classList.contains(v)
                    ? (i = !1)
                    : (e = r.querySelector(".active")) && p(e).removeClass(v)),
                i &&
              ...
              this._element.hasAttribute("disabled") ||
                ...
                i && p(this._element).toggleClass(v));
          }),
          (t.dispose = function () {
          ...
          (i._jQueryInterface = function (e) {
            return this.each(function () {
              var t = p(this).data(f);
              t || ((t = new i(this)), p(this).data(f, t)),
                "toggle" === e && t[e]();
            });
          }),
          o(i, null, [
    ...
    p(document)
      .on("click.bs.button.data-api", y, function (t) {
        var e = t.target,
          i = e;
        if (
          (p(e).hasClass("btn") || (e = p(e).closest(".btn")[0]),
          !e || e.hasAttribute("disabled") || e.classList.contains("disabled"))
        )
          t.preventDefault();
        else {
          var n = e.querySelector(_);
          if (
            n &&
          ...
          "LABEL" === i.tagName &&
            ...
            "checkbox" === n.type &&
            t.preventDefault(),
            w._jQueryInterface.call(p(e), "toggle");
        }
      })
      .on("focus.bs.button.data-api blur.bs.button.data-api", y, function (t) {
      ...
      (p.fn[d].noConflict = function () {
        return (p.fn[d] = m), w._jQueryInterface;
      });
    var b = "carousel",
      x = "bs.start-online-classes",
      C = "." + x,
      T = p.fn[b],
      S = {
        interval: 5e3,
      ...
      M = "slid" + C,
      N = "active",
      O = ".active.start-online-classes-item",
        ...
        function s(t, e) {
          (this._items = null),
            ...
            (this._indicatorsElement = this._element.querySelector(
              ".start-online-classes-indicators"
            )),
        ...
        return (
          ...
          (t.pause = function (t) {
            t || (this._isPaused = !0),
              this._element.querySelector(
                ".start-online-classes-item-next, .start-online-classes-item-prev"
          ...
          (t.to = function (t) {
            ...
            if (!(t > this._items.length - 1 || t < 0))
              if (this._isSliding)
                p(this._element).one(M, function () {
                  return e.to(t);
                });
              else {
          ...
          (t._getConfig = function (t) {
            return (t = l(l({}, S), t)), g.typeCheckConfig(b, t, k), t;
          }),
          ...
          (t._addEventListeners = function () {
            ...
            this._config.keyboard &&
              p(this._element).on("keydown.bs.start-online-classes", function (
                t
              ) {
                return e._keydown(t);
              }),
              "hover" === this._config.pause &&
                p(this._element)
                  .on("mouseenter.bs.start-online-classes", function (t) {
                    return e.pause(t);
                  })
                  .on("mouseleave.bs.start-online-classes", function (t) {
                    return e.cycle(t);
                  }),
          ...
          (t._addTouchEventListeners = function () {
            ...
            this._touchSupported &&
              ((t = function (t) {
                i._pointerEvent && A[t.originalEvent.pointerType.toUpperCase()]
              ...
              p(
                this._element.querySelectorAll(".start-online-classes-item img")
              ).on("dragstart.bs.start-online-classes", function (t) {
                return t.preventDefault();
              }),
              this._pointerEvent
                ? (p(this._element).on(
                    "pointerdown.bs.start-online-classes",
                    t
                  ),
                  p(this._element).on("pointerup.bs.start-online-classes", e),
                  this._element.classList.add("pointer-event"))
                : (p(this._element).on("touchstart.bs.start-online-classes", t),
                  p(this._element).on(
                    "touchmove.bs.start-online-classes",
                    function (t) {
                      var e;
                  ...
                  p(this._element).on("touchend.bs.start-online-classes", e)));
          }),
          ...
          (t._triggerSlideEvent = function (t, e) {
            var i = this._getItemIndex(t),
              ...
              r = p.Event("slide.bs.start-online-classes", {
                relatedTarget: t,
                direction: e,
                from: n,
                to: i,
          ...
          (t._slide = function (t, e) {
            var i,
              ...
              o,
              a = this,
              l = this._element.querySelector(O),
              ...
              f =
                t === E
                  ? ((i = "start-online-classes-item-left"),
                    (n = "start-online-classes-item-next"),
                    "left")
                  : ((i = "start-online-classes-item-right"),
                    (n = "start-online-classes-item-prev"),
                    "right");
            u && p(u).hasClass(N)
              ? (this._isSliding = !1)
                ...
                (l &&
                  ...
                  p(this._element).hasClass("slide")
                    ? (p(u).addClass(n),
                      ...
                      p(l).addClass(i),
                      p(u).addClass(i),
                      (s = parseInt(u.getAttribute("data-interval"), 10))
                        ...
                        : (this._config.interval =
                            this._config.defaultInterval ||
                            this._config.interval),
                      (o = g.getTransitionDurationFromElement(l)),
                      p(l)
                        .one(g.TRANSITION_END, function () {
                          p(u)
                            .removeClass(i + " " + n)
                            .addClass(N),
                            p(l).removeClass(N + " " + n + " " + i),
                            (a._isSliding = !1),
                            setTimeout(function () {
          ...
          (s._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (t || ((t = new s(this, e)), p(this).data(x, t)),
                "number" == typeof n)
              )
                t.to(n);
          ...
          (s._dataApiClickHandler = function (t) {
            ...
            !r ||
              ((e = p(r)[0]) &&
                ...
                ((i = l(l({}, p(e).data()), p(this).data())),
                (n = this.getAttribute("data-slide-to")) && (i.interval = !1),
                s._jQueryInterface.call(p(e), i),
                n && p(e).data(x).to(n),
                t.preventDefault()));
          }),
          o(s, null, [
    ...
    p(document).on(
      "click.bs.start-online-classes.data-api",
      "[data-slide], [data-slide-to]",
      R._dataApiClickHandler
    ),
      p(window).on("load.bs.start-online-classes.data-api", function () {
        for (
          var t = [].slice.call(
              document.querySelectorAll('[data-ride="start-online-classes"]')
            ),
            e = 0,
            i = t.length;
          e < i;
      ...
      (p.fn[b] = R._jQueryInterface),
      (p.fn[b].Constructor = R),
      (p.fn[b].noConflict = function () {
        return (p.fn[b] = T), R._jQueryInterface;
      });
    var j = "collapse",
      P = "bs.collapse",
      L = p.fn[j],
      ...
      $ = (function () {
        ...
        return (
          ...
          (t.show = function () {
            ...
            this._isTransitioning ||
              ...
              (this._parent &&
                ...
                (t = null),
              (t &&
                (e = p(t).not(this._selector).data(P)) &&
                e._isTransitioning) ||
                ...
                i.isDefaultPrevented() ||
                  ...
                  p(this._element).removeClass(Y).addClass(q),
                  ...
                  p(this._element)
                    .one(g.TRANSITION_END, function () {
                      p(o._element)
                        ...
                        p(o._element).trigger("shown.bs.collapse");
                    })
                ...
                if (0 < n)
                  for (var r = 0; r < n; r++) {
                    var s = this._triggerArray[r],
                      o = g.getSelectorFromElement(s);
                    null !== o &&
                      (p([].slice.call(document.querySelectorAll(o))).hasClass(
                        W
                      ) ||
                        p(s).addClass(F).attr("aria-expanded", !1));
                  }
                this.setTransitioning(!0);
                this._element.style[i] = "";
          ...
          (t._getConfig = function (t) {
            return (
              ((t = l(l({}, H), t)).toggle = Boolean(t.toggle)),
              g.typeCheckConfig(j, t, I),
              t
            );
          }),
          ...
          (t._addAriaAndCollapsedClass = function (t, e) {
            var i = p(t).hasClass(W);
            e.length && p(e).toggleClass(F, !i).attr("aria-expanded", i);
          }),
    ...
    p(document).on("click.bs.collapse.data-api", z, function (t) {
      ...
      p(n).each(function () {
        ...
        $._jQueryInterface.call(t, e);
      });
    }),
      (p.fn[j] = $._jQueryInterface),
      (p.fn[j].Constructor = $),
      (p.fn[j].noConflict = function () {
        return (p.fn[j] = L), $._jQueryInterface;
      });
    var B = "dropdown",
      V = "bs.dropdown",
      U = "." + V,
        ...
        return (
          ...
          (t.show = function (t) {
            if (
              ...
              var e = { relatedTarget: this._element },
                ...
                n = h._getParentFromElement(this._element);
              if ((p(n).trigger(i), !i.isDefaultPrevented())) {
                ...
                "ontouchstart" in document.documentElement &&
                  ...
                  p(n).toggleClass(it).trigger(p.Event("shown.bs.dropdown", e));
              }
            }
          }),
          (t.hide = function () {
            ...
            this._element.disabled ||
              ...
              e.isDefaultPrevented() ||
                ...
                p(this._menu).toggleClass(it),
                p(i).toggleClass(it).trigger(p.Event(K, t))));
          }),
          (t.dispose = function () {
            p.removeData(this._element, V),
              p(this._element).off(U),
              (this._element = null),
          ...
          (t._getConfig = function (t) {
            return (
              ...
              g.typeCheckConfig(B, t, this.constructor.DefaultType),
              t
            );
          }),
          (t._getMenuElement = function () {
            ...
            return (
              this._menu ||
                ((t = h._getParentFromElement(this._element)) &&
          ...
          (t._getPlacement = function () {
            ...
            return (
              t.hasClass("dropup")
                ? (e = p(this._menu).hasClass(nt) ? "top-end" : "top-start")
                : t.hasClass("dropright")
                ? (e = "right-start")
                : t.hasClass("dropleft")
                ? (e = "left-start")
                : p(this._menu).hasClass(nt) && (e = "bottom-end"),
              e
            );
          }),
                    ...
                    p(o).hasClass(it) &&
                      ((t &&
                        ...
                        s.isDefaultPrevented() ||
                          ...
                          p(r).removeClass(it),
                          p(o).removeClass(it).trigger(p.Event(K, l))))));
              }
          }),
            ...
            if (
              ...
              if (i || 27 !== t.which) {
                if (
                  ...
                  return (
                    27 === t.which && p(e.querySelector(rt)).trigger("focus"),
                ...
                0 !== r.length &&
                  ((n = r.indexOf(t.target)),
                  38 === t.which && 0 < n && n--,
                  40 === t.which && n < r.length - 1 && n++,
                  n < 0 && (n = 0),
                  r[n].focus());
              }
            }
    ...
    p(document)
      ...
      .on(J + " keyup.bs.dropdown.data-api", lt._clearMenus)
      .on(J, rt, function (t) {
        t.preventDefault(),
          t.stopPropagation(),
      ...
      (p.fn[B] = lt._jQueryInterface),
      (p.fn[B].Constructor = lt),
      (p.fn[B].noConflict = function () {
        return (p.fn[B] = Q), lt._jQueryInterface;
      });
    var ht = "modal",
      ut = "bs.modal",
      ct = "." + ut,
      ...
      Dt = (function () {
        ...
        return (
          ...
          (t.show = function (t) {
            ...
            this._isShown ||
              ...
              this._isShown ||
                ...
                p(this._element).on(_t, '[data-dismiss="modal"]', function (t) {
                  return i.hide(t);
                }),
            ...
            t && t.preventDefault(),
              this._isShown &&
                ...
                this._isShown &&
                  !e.isDefaultPrevented() &&
                  ((this._isShown = !1),
                  (i = p(this._element).hasClass(Ct)) &&
                    (this._isTransitioning = !0),
                  this._setEscapeEvent(),
                  this._setResizeEvent(),
                  p(document).off(vt),
                  p(this._element).removeClass(Tt),
                  p(this._element).off(_t),
          ...
          (t._getConfig = function (t) {
            return (t = l(l({}, ft), t)), g.typeCheckConfig(ht, t, pt), t;
          }),
          ...
          (t._showElement = function (t) {
            ...
            var s,
              o = p.Event("shown.bs.modal", { relatedTarget: t });
            i
          ...
          (t._setEscapeEvent = function () {
            var e = this;
            this._isShown
              ? p(this._element).on(wt, function (t) {
          ...
          (t._showBackdrop = function (t) {
            var e,
              i,
              n = this,
              r = p(this._element).hasClass(Ct) ? Ct : "";
            if (this._isShown && this._config.backdrop) {
              if (
                ...
                p(this._element).on(_t, function (t) {
              ...
              !this._isShown && this._backdrop
                ? (p(this._backdrop).removeClass(Tt),
                  ...
                  p(this._element).hasClass(Ct)
                    ? ((i = g.getTransitionDurationFromElement(this._backdrop)),
                      p(this._backdrop)
          ...
          (r._jQueryInterface = function (i, n) {
            return this.each(function () {
              var t = p(this).data(ut),
                e = l(
                  l(l({}, ft), p(this).data()),
                  "object" == typeof i && i ? i : {}
                );
              if (
                (t || ((t = new r(this, e)), p(this).data(ut, t)),
                "string" == typeof i)
              ) {
                if (void 0 === t[i])
                  throw new TypeError('No method named "' + i + '"');
    ...
    p(document).on(
      ...
      function (t) {
        ...
        var r = p(e).data(ut)
          ? "toggle"
          : l(l({}, p(e).data()), p(this).data());
        ("A" !== this.tagName && "AREA" !== this.tagName) || t.preventDefault();
        var s = p(e).one(mt, function (t) {
          t.isDefaultPrevented() ||
            s.one(gt, function () {
              p(i).is(":visible") && i.focus();
            });
        });
        Dt._jQueryInterface.call(p(e), r, this);
      }
    ),
      (p.fn[ht] = Dt._jQueryInterface),
      (p.fn[ht].Constructor = Dt),
      (p.fn[ht].noConflict = function () {
        return (p.fn[ht] = dt), Dt._jQueryInterface;
      });
    var Mt = [
        "background",
        "cite",
            ...
            n.forEach(function (t) {
              !(function (t, e) {
                ...
                if (-1 !== e.indexOf(i))
                  return (
                    -1 === Mt.indexOf(i) ||
                    Boolean(t.nodeValue.match(Ot) || t.nodeValue.match(At))
                  );
                for (
      ...
      Xt = (function () {
        ...
        return (
          ...
          (t.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              r.setAttribute("id", s),
                ...
                this.setContent(),
                this.config.animation && p(r).addClass(Vt);
              var o =
              ...
              p(this.tip).hasClass(Vt)
                ? ((h = g.getTransitionDurationFromElement(this.tip)),
                  p(this.tip).one(g.TRANSITION_END, u).emulateTransitionEnd(h))
                : u();
            }
          }),
          (t.hide = function (t) {
            ...
            p(this.element).trigger(s),
              s.isDefaultPrevented() ||
                ...
                p(this.tip).hasClass(Vt)
                  ? ((i = g.getTransitionDurationFromElement(r)),
                    p(r).one(g.TRANSITION_END, e).emulateTransitionEnd(i))
                  : e(),
                (this._hoverState = ""));
          }),
          (t.update = function () {
          ...
          (t.addAttachmentClass = function (t) {
            p(this.getTipElement()).addClass(It + "-" + t);
          }),
          ...
          (t.setContent = function () {
            ...
            this.setElementContent(
              ...
              p(t).removeClass(Vt + " " + Ut);
          }),
          (t.setElementContent = function (t, e) {
            "object" != typeof e || (!e.nodeType && !e.jquery)
              ? this.config.html
                ? (this.config.sanitize &&
                    (e = Rt(e, this.config.whiteList, this.config.sanitizeFn)),
                  t.html(e))
                : t.text(e)
              : this.config.html
          ...
          (t._enter = function (t, e) {
            ...
            (e = e || p(t.currentTarget).data(i)) ||
              ...
              t && (e._activeTrigger["focusin" === t.type ? Qt : Gt] = !0),
              p(e.getTipElement()).hasClass(Ut) || e._hoverState === $t
                ? (e._hoverState = $t)
          ...
          (t._leave = function (t, e) {
            ...
            (e = e || p(t.currentTarget).data(i)) ||
              ...
              p(t.currentTarget).data(i, e)),
              t && (e._activeTrigger["focusout" === t.type ? Qt : Gt] = !1),
          ...
          (t._getConfig = function (t) {
            ...
            return (
              ...
              t.sanitize &&
                (t.template = Rt(t.template, t.whiteList, t.sanitizeFn)),
              t
            );
          }),
          ...
          (n._jQueryInterface = function (i) {
            return this.each(function () {
              var t = p(this).data(Pt),
                e = "object" == typeof i && i;
              if (
                (t || !/dispose|hide/.test(i)) &&
                (t || ((t = new n(this, e)), p(this).data(Pt, t)),
                "string" == typeof i)
              ) {
                if (void 0 === t[i])
                  throw new TypeError('No method named "' + i + '"');
    ...
    (p.fn[jt] = Xt._jQueryInterface),
      (p.fn[jt].Constructor = Xt),
      (p.fn[jt].noConflict = function () {
        return (p.fn[jt] = Ht), Xt._jQueryInterface;
      });
    var Zt = "popover",
      Kt = "bs.popover",
      Jt = "." + Kt,
      ...
      oe = (function (t) {
        ...
        return (
          ...
          (r.addAttachmentClass = function (t) {
            p(this.getTipElement()).addClass(ee + "-" + t);
          }),
          ...
          (n._jQueryInterface = function (i) {
            return this.each(function () {
              var t = p(this).data(Kt),
                e = "object" == typeof i ? i : null;
              if (
                (t || !/dispose|hide/.test(i)) &&
                (t || ((t = new n(this, e)), p(this).data(Kt, t)),
                "string" == typeof i)
              ) {
                if (void 0 === t[i])
                  throw new TypeError('No method named "' + i + '"');
    ...
    (p.fn[Zt] = oe._jQueryInterface),
      (p.fn[Zt].Constructor = oe),
      (p.fn[Zt].noConflict = function () {
        return (p.fn[Zt] = te), oe._jQueryInterface;
      });
    var ae = "scrollspy",
      le = "bs.scrollspy",
      he = "." + le,
      ...
      ye = (function () {
        ...
        return (
              ...
              [].slice
                ...
                .map(function (t) {
                  ...
                  if ((i && (e = document.querySelector(i)), e)) {
                    ...
                    if (n.width || n.height) return [p(e)[r]().top + s, i];
                  }
                  return null;
                })
                .filter(function (t) {
          ...
          (t.dispose = function () {
            p.removeData(this._element, le),
              p(this._scrollElement).off(he),
              (this._element = null),
          ...
          (t._getConfig = function (t) {
            ...
            return (
              "string" !=
                typeof (t = l(l({}, ce), "object" == typeof t && t ? t : {}))
                  .target &&
                g.isElement(t.target) &&
                ((e = p(t.target).attr("id")) ||
                  ((e = g.getUID(ae)), p(t.target).attr("id", e)),
                (t.target = "#" + e)),
              g.typeCheckConfig(ae, t, de),
              t
            );
          }),
          ...
          (t._activate = function (e) {
            ...
            i.hasClass("dropdown-item")
              ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(fe),
                i.addClass(fe))
              : (i.addClass(fe),
                i
                  .parents(pe)
                  .prev(ge + ", " + me)
                  .addClass(fe),
                i.parents(pe).prev(".nav-item").children(ge).addClass(fe)),
    ...
    p(window).on("load.bs.scrollspy.data-api", function () {
      ...
      (p.fn[ae] = ye._jQueryInterface),
      (p.fn[ae].Constructor = ye),
      (p.fn[ae].noConflict = function () {
        return (p.fn[ae] = ue), ye._jQueryInterface;
      });
    var _e = "bs.tab",
      we = p.fn.tab,
      be = "active",
      ...
      Te = (function () {
        ...
        return (
          (t.show = function () {
            ...
            (this._element.parentNode &&
              this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
              p(this._element).hasClass(be)) ||
              p(this._element).hasClass("disabled") ||
              ((e = p(this._element).closest(".nav, .list-group")[0]),
              (i = g.getSelectorFromElement(this._element)),
              e &&
                ((n = "UL" === e.nodeName || "OL" === e.nodeName ? Ce : xe),
                (r = (r = p.makeArray(p(e).find(n)))[r.length - 1])),
              (s = p.Event("hide.bs.tab", { relatedTarget: this._element })),
              (o = p.Event("show.bs.tab", { relatedTarget: r })),
              r && p(r).trigger(s),
              ...
              o.isDefaultPrevented() ||
                ...
                (a = function () {
                  var t = p.Event("hidden.bs.tab", {
                    ...
                    e = p.Event("shown.bs.tab", { relatedTarget: r });
                  p(r).trigger(t), p(l._element).trigger(e);
                }),
                t ? this._activate(t, t.parentNode, a) : a()));
          }),
          (t.dispose = function () {
            p.removeData(this._element, _e), (this._element = null);
          }),
          (t._activate = function (t, e, i) {
            ...
            var r,
              ...
              o = (!e || ("UL" !== e.nodeName && "OL" !== e.nodeName)
                ? p(e).children(xe)
                : p(e).find(Ce))[0],
              a = i && o && p(o).hasClass("fade");
            o && a
              ? ((r = g.getTransitionDurationFromElement(o)),
                p(o)
                  .removeClass("show")
          ...
          (t._transitionComplete = function (t, e, i) {
            ...
            e &&
              (p(e).removeClass(be),
              (n = p(e.parentNode).find("> .dropdown-menu .active")[0]) &&
                p(n).removeClass(be),
              ...
              t.parentNode &&
                ...
                ((r = p(t).closest(".dropdown")[0]) &&
                  ((s = [].slice.call(r.querySelectorAll(".dropdown-toggle"))),
                  p(s).addClass(be)),
          ...
          (n._jQueryInterface = function (i) {
            return this.each(function () {
              var t = p(this),
                e = t.data(_e);
              if (
                (e || ((e = new n(this)), t.data(_e, e)), "string" == typeof i)
              ) {
                if (void 0 === e[i])
                  throw new TypeError('No method named "' + i + '"');
                e[i]();
    ...
    p(document).on(
      ...
      function (t) {
        t.preventDefault(), Te._jQueryInterface.call(p(this), "show");
      }
    ),
      (p.fn.tab = Te._jQueryInterface),
      (p.fn.tab.Constructor = Te),
      (p.fn.tab.noConflict = function () {
        return (p.fn.tab = we), Te._jQueryInterface;
      });
    var Se = "toast",
      ke = "bs.toast",
      Ee = "." + ke,
        ...
        return (
          (t.show = function () {
            ...
            p(this._element).trigger(n),
              n.isDefaultPrevented() ||
                ...
                (t = function () {
                  i._element.classList.remove(Oe),
                    i._element.classList.add(Ne),
                ...
                this._config.animation
                  ? ((e = g.getTransitionDurationFromElement(this._element)),
                    p(this._element)
                      .one(g.TRANSITION_END, t)
          ...
          (t.dispose = function () {
            clearTimeout(this._timeout),
              ...
              p(this._element).off(Me),
              p.removeData(this._element, ke),
              (this._element = null),
              (this._config = null);
          }),
          (t._getConfig = function (t) {
            return (
              (t = l(
                l(l({}, Re), p(this._element).data()),
                "object" == typeof t && t ? t : {}
              )),
              g.typeCheckConfig(Se, t, this.constructor.DefaultType),
              t
            );
          }),
          (t._setListeners = function () {
            var t = this;
            p(this._element).on(Me, '[data-dismiss="toast"]', function () {
              return t.hide();
            });
          }),
          (t._close = function () {
          ...
          (n._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                (e ||
                  ((e = new n(this, "object" == typeof i && i)), t.data(ke, e)),
                "string" == typeof i)
              ) {
                if (void 0 === e[i])
                  throw new TypeError('No method named "' + i + '"');
    ...
    (p.fn[Se] = je._jQueryInterface),
      ...
      (p.fn[Se].noConflict = function () {
        return (p.fn[Se] = De), je._jQueryInterface;
      }),
      (t.Alert = u),
      (t.Button = w),
      (t.Carousel = R),
  ...
  (function (T, F, z) {
    ...
    (t = function (P) {
      ...
      (P.SPFormatClass = v = e({
        ...
        render: function (t, e, i) {
          ...
          return this.format.replace(this.fre, function () {
            return (
              (r = arguments[1]),
              (s = arguments[3]),
              (n = l.precre.exec(r)) ? ((a = n[2]), (r = n[1])) : (a = !1),
              (o = h[r]) === z
                ? ""
                : s && e && e[s]
                ? e[s].get
                  ...
                  : e[s][o] || o
                : (u(o) &&
                    (o = i.get("numberFormatter")
                      ? i.get("numberFormatter")(o)
                      : c(
                          o,
                          a,
        ...
        (I = function (t) {
          for (var e = [], i = t.length; i--; ) e[i] = H(t[i]);
          return e;
        }),
        (W = function (t, e) {
        ...
        (c = function (t, e, i, n, r) {
          ...
          for (
            t = (!1 === e ? parseFloat(t).toString() : t.toFixed(e)).split(""),
              (s = (s = P.inArray(".", t)) < 0 ? t.length : s) < t.length &&
                (t[s] = r),
              o = s - i;
            0 < o;
            o -= i
        ...
        (i = function (t) {
          ...
          if (T.createStyleSheet)
            try {
              return void (T.createStyleSheet().cssText = t);
            } catch (t) {
              i = !0;
            }
          ((e = T.createElement("style")).type = "text/css"),
            ...
            i
              ? (T.styleSheets[T.styleSheets.length - 1].cssText = t)
              : (e[
        ...
        (P.fn.simpledraw = function (t, e, i, n) {
          var r, s;
          if (i && (r = this.data("_jqs_vcanvas"))) return r;
          if (!1 === P.fn.sparkline.canvas) return !1;
          if (P.fn.sparkline.canvas === z) {
            var o = T.createElement("canvas");
            if (o.getContext && o.getContext("2d"))
              P.fn.sparkline.canvas = function (t, e, i, n) {
                return new g(t, e, i, n);
              };
            else {
              if (!T.namespaces || T.namespaces.v)
                return (P.fn.sparkline.canvas = !1);
              T.namespaces.add(
                "v",
          ...
          return (
            t === z && (t = P(this).innerWidth()),
            e === z && (e = P(this).innerHeight()),
            (r = P.fn.sparkline.canvas(t, e, this, n)),
            (s = P(this).data("_jqs_mhandler")) && s.registerCanvas(r),
            r
          );
        }),
        (P.fn.cleardraw = function () {
        ...
        (d = e({
          ...
          registerCanvas: function (t) {
            var e = P(t.canvas);
            (this.canvas = t),
              (this.$canvas = e).mouseenter(P.proxy(this.mouseenter, this)),
              e.mouseleave(P.proxy(this.mouseleave, this)),
              e.click(P.proxy(this.mouseclick, this));
          },
          reset: function (t) {
            (this.splist = []),
          ...
          mouseclick: function (t) {
            var e = P.Event("sparklineClick");
            (e.originalEvent = t),
              (e.sparklines = this.splist),
              this.$el.trigger(e);
          },
          mouseenter: function (t) {
            P(T.body).unbind("mousemove.jqs"),
              P(T.body).bind("mousemove.jqs", P.proxy(this.mousemove, this)),
              (this.over = !0),
              ...
              !this.tooltip &&
                ...
                ((this.tooltip = new n(this.options)),
          ...
          updateDisplay: function () {
            var t,
              ...
              h = this.currentPageY - a.top;
            if (this.over) {
              for (e = 0; e < s; e++)
                (i = r[e].setRegionHighlight(this.currentEl, l, h)) && (o = !0);
              if (o) {
                if (
                  (((n = P.Event(
        ...
        (n = e({
          ...
          init: function (t) {
            var e,
              ...
              n = this.sizeStyle;
            (this.container = t.get("tooltipContainer") || T.body),
              ...
              (this.hidden = !0),
              P(window).unbind("resize.jqs scroll.jqs"),
              P(window).bind(
                "resize.jqs scroll.jqs",
                P.proxy(this.updateWindowDims, this)
              ),
              this.updateWindowDims();
          },
          updateWindowDims: function () {
            (this.scrollTop = P(window).scrollTop()),
              (this.scrollLeft = P(window).scrollLeft()),
              (this.scrollRight = this.scrollLeft + P(window).width()),
              this.updatePosition();
          },
          getSize: function (t) {
          ...
          return this.each(function () {
            function t() {
              var t,
                ...
                s =
                  "html" === h || h === z
                    ? (((r = this.getAttribute(a.get("tagValuesAttribute"))) !==
                        z &&
                        null !== r) ||
                        (r = l.html()),
                ...
                o =
                  "auto" === a.get("width")
                    ? s.length * a.get("defaultPixelsPerValue")
                    : a.get("width");
              "auto" === a.get("height")
                ? (a.get("composite") && P.data(this, "_jqs_vcanvas")) ||
                  (((e = T.createElement("span")).innerHTML = "a"),
                  l.html(e),
                  (t = P(e).innerHeight() || P(e).height()),
                  P(e).remove(),
                  (e = null))
                : (t = a.get("height")),
                a.get("disableInteraction")
                  ? (i = !1)
                  : (i = P.data(this, "_jqs_mhandler"))
                  ? a.get("composite") || i.reset()
                  : ((i = new d(this, a)), P.data(this, "_jqs_mhandler", i)),
                !a.get("composite") || P.data(this, "_jqs_vcanvas")
                  ? ((n = new P.fn.sparkline[a.get("type")](
                      this,
                      s,
                      a,
                      o,
                    ...
                    i && i.registerSparkline(n))
                  : P.data(this, "_jqs_errnotify") ||
                    (alert(
                      "Attempted to attach a composite sparkline to an element with no existing sparkline"
                    ),
                    P.data(this, "_jqs_errnotify", !0));
            }
            var e,
              a = new P.fn.sparkline.options(this, i),
              l = P(this);
            if (
              (P(this).html() &&
                !a.get("disableHiddenCheck") &&
                P(this).is(":hidden")) ||
              !P(this).parents("body").length
            ) {
              if (!a.get("composite") && P.data(this, "_jqs_pending"))
                for (e = y.length; e; e--)
                  y[e - 1][0] == this && y.splice(e - 1, 1);
              y.push([this, t]), P.data(this, "_jqs_pending", !0);
            } else t.call(this);
          });
        }),
        (P.fn.sparkline.defaults = t()),
        (P.sparkline_display_visible = function () {
          for (var t, e = [], i = 0, n = y.length; i < n; i++)
            (t = y[i][0]),
              P(t).is(":visible") && !P(t).parents().is(":hidden")
                ? (y[i][1].call(t),
                  P.data(y[i][0], "_jqs_pending", !1),
                  e.push(i))
                : P(t).closest("html").length ||
                  P.data(t, "_jqs_pending") ||
                  (P.data(y[i][0], "_jqs_pending", !1), e.push(i));
          for (i = e.length; i; i--) y.splice(e[i - 1], 1);
        }),
        (P.fn.sparkline.options = e({
          init: function (t, e) {
            var i, n, r, s;
            (this.userOptions = e = e || {}),
              (this.tag = t),
              (this.tagValCache = {}),
              (r = (n = P.fn.sparkline.defaults).common),
              (this.tagOptionsPrefix =
                e.enableTagOptions &&
                (e.tagOptionsPrefix || r.tagOptionsPrefix)),
              (i =
                (s = this.getTagSetting("type")) === _
                  ? n[e.type || r.type]
                  : n[s]),
              (this.mergedOptions = P.extend({}, r, i, e));
          },
          getTagSetting: function (t) {
            ...
            if (this.tagValCache.hasOwnProperty(t)) e = this.tagValCache.key;
              ...
              if ((e = this.tag.getAttribute(s + t)) === z || null === e) e = _;
                ...
                for (
                  ...
                  e[i] = H(e[i].replace(/(^\s*)|(\s*$)/g, ""));
              else if ("{" === e.substr(0, 1))
                for (
                  n = e.substr(1, e.length - 2).split(","),
                    e = {},
                    i = n.length;
                  i--;
          ...
          get: function (t, e) {
            ...
            return n !== _ ? n : (i = this.mergedOptions[t]) === z ? e : i;
          },
        })),
        (P.fn.sparkline._base = e({
          disabled: !1,
          ...
          setRegionHighlight: function (t, e, i) {
            ...
            return e > this.canvasWidth ||
              ...
              i < 0
              ? null
              : r !== (n = this.getRegion(t, e, i)) &&
                  (r !== z && s && this.removeHighlight(),
                  (this.currentRegion = n) !== z && s && this.renderHighlight(),
                  !0);
          },
          ...
          getCurrentRegionTooltip: function () {
            ...
            if (
              (P.isArray(e) || (e = [e]),
              P.isArray(t) || (t = [t]),
              (o = this.options.get("tooltipFormatFieldlist")),
              (a = this.options.get("tooltipFormatFieldlistKey")),
              o && a)
            ) {
              for (l = [], s = t.length; s--; )
                (h = t[s][a]), -1 != (f = P.inArray(h, o)) && (l[f] = t[s]);
              t = l;
            }
            for (i = e.length, d = t.length, s = 0; s < i; s++)
              for (
                "string" == typeof (c = e[s]) && (c = new v(c)),
                  n = c.fclass || "jqsfield",
                  f = 0;
                f < d;
                f++
              )
                (t[f].isNull && p.get("tooltipSkipNull")) ||
                  (P.extend(t[f], {
                    prefix: p.get("tooltipPrefix"),
                    suffix: p.get("tooltipSuffix"),
                  }),
                  (r = c.render(t[f], p.get("tooltipValueLookups"), p)),
                  m.push('<div class="' + n + '">' + r + "</div>"));
          ...
          calcHighlightColor: function (t, e) {
            ...
            if (
              ...
              for (r = [], n = 4 === t.length ? 16 : 1, s = 0; s < 3; s++)
                r[s] = L(F.round(parseInt(i[s + 1], 16) * n * a), 0, 255);
              return "rgb(" + r.join(",") + ")";
            }
            return t;
          },
        ...
        (r = {
          changeHighlight: function (t) {
            ...
            r &&
              ...
              P.isArray(e) || P.isArray(r)
                ? (n.replaceWithShapes(r, e),
                  (this.regionShapes[i] = P.map(e, function (t) {
                    return t.id;
                  })))
                : (n.replaceWithShape(r, e), (this.regionShapes[i] = e.id)));
          },
          render: function () {
            var t,
              e,
        ...
        (P.fn.sparkline.line = O = e(P.fn.sparkline._base, {
          type: "line",
          init: function (t, e, i, n, r) {
            O._super.init.call(this, t, e, i, n, r),
              (this.vertices = []),
              (this.regionMap = []),
              (this.xvalues = []),
              (this.yvalues = []),
          ...
          getRegion: function (t, e, i) {
            for (var n = this.regionMap, r = n.length; r--; )
          ...
          renderHighlight: function () {
            var t,
              ...
              s = this.options,
              o = s.get("spotRadius"),
              a = s.get("highlightSpotColor"),
              l = s.get("highlightLineColor");
            r &&
              (o &&
                a &&
                ((t = n.drawCircle(r[0], r[1], o, z, a)),
              ...
              l &&
                ...
                n.insertAfterShape(this.lastShapeId, e)));
          },
          removeHighlight: function () {
            var t = this.target;
          ...
          scanValues: function () {
            for (
              ...
              (t = r[h]),
                (e = "string" == typeof r[h]),
                (i = "object" == typeof r[h] && r[h] instanceof Array),
                (n = e && r[h].split(":")),
                e && 2 === n.length
                  ? (o.push(Number(n[0])),
                    a.push(Number(n[1])),
                    l.push(Number(n[1])))
                  : i
                  ? (o.push(t[0]), a.push(t[1]), l.push(t[1]))
                  : (o.push(h),
                    null === r[h] || "null" === r[h]
                      ? a.push(null)
                      : (a.push(Number(t)), l.push(Number(t))));
          ...
          drawNormalRange: function (t, e, i, n, r) {
            var s = this.options.get("normalRangeMin"),
              o = this.options.get("normalRangeMax"),
              a = e + F.round(i - i * ((o - this.miny) / r)),
              l = F.round((i * (o - s)) / r);
            this.target
              .drawRect(t, a, n, l, z, this.options.get("normalRangeColor"))
              .append();
          },
          render: function () {
            var t,
            ...
            if (
              ...
              for (
                n = r = 0,
                  ...
                  M &&
                    (((_ =
                      T.get("highlightSpotColor") &&
                      !T.get("disableInteraction")) ||
                      T.get("minSpotColor") ||
                      (T.get("spotColor") && x[i] === this.miny)) &&
                      (E -= F.ceil(M)),
                    (_ ||
                      T.get("maxSpotColor") ||
                      (T.get("spotColor") && x[i] === this.maxy)) &&
                      ((E -= F.ceil(M)), (n += F.ceil(M))),
                    (!_ &&
                      ((!T.get("minSpotColor") && !T.get("maxSpotColor")) ||
                        (x[0] !== this.miny && x[0] !== this.maxy))) ||
                      ((r += F.ceil(M)), (k -= F.ceil(M))),
                    (_ ||
                      T.get("spotColor") ||
                      T.get("minSpotColor") ||
                      (T.get("maxSpotColor") &&
                        (x[i] === this.miny || x[i] === this.maxy))) &&
                      (k -= F.ceil(M))),
                  E--,
                  T.get("normalRangeMin") === z ||
                    T.get("drawNormalOnTop") ||
                    this.drawNormalRange(r, n, E, k, e),
                  a = [(o = [])],
                  d = f = null,
                  p = x.length,
                  C = 0;
                ...
                (l = b[C]),
                  ...
                  (h = x[C]),
                  (f =
                    (c = r + F.round((l - this.minx) * (k / t))) +
                    ((C < p - 1 ? r + F.round((u - this.minx) * (k / t)) : k) -
                      c) /
                      2),
                  (N[C] = [d || 0, f, C]),
                  (d = f),
                  null === h
                    ? C &&
                      (null !== x[C - 1] && ((o = []), a.push(o)), D.push(null))
                    : (h < this.miny && (h = this.miny),
                      h > this.maxy && (h = this.maxy),
                      o.length || o.push([c, n + E]),
                      (s = [c, n + F.round(E - E * ((h - this.miny) / e))]),
                      o.push(s),
                      D.push(s));
              for (g = [], m = [], v = a.length, C = 0; C < v; C++)
                (o = a[C]).length &&
                  (T.get("fillColor") &&
                    (o.push([o[o.length - 1][0], n + E]),
                    m.push(o.slice(0)),
                    o.pop()),
                  2 < o.length && (o[0] = [o[0][0], o[1][1]]),
                  g.push(o));
              ...
              if (M && T.get("valueSpots"))
                for (
                  (y = T.get("valueSpots")).get === z && (y = new Y(y)), C = 0;
                  C < p;
                  C++
                )
                  (w = y.get(x[C])) &&
                    S.drawCircle(
                      r + F.round((b[C] - this.minx) * (k / t)),
                      n + F.round(E - E * ((x[C] - this.miny) / e)),
                      M,
                      z,
                      w
                    ).append();
              M &&
                ...
                null !== x[i] &&
                S.drawCircle(
                  r + F.round((b[b.length - 1] - this.minx) * (k / t)),
                  n + F.round(E - E * ((x[i] - this.miny) / e)),
                  M,
                  z,
                  T.get("spotColor")
                ).append(),
                this.maxy !== this.minyorg &&
                  (M &&
                    T.get("minSpotColor") &&
                    ((l = b[P.inArray(this.minyorg, x)]),
                    S.drawCircle(
                      r + F.round((l - this.minx) * (k / t)),
                      n + F.round(E - E * ((this.minyorg - this.miny) / e)),
                      M,
                      z,
                      T.get("minSpotColor")
                    ).append()),
                  M &&
                    T.get("maxSpotColor") &&
                    ((l = b[P.inArray(this.maxyorg, x)]),
                    S.drawCircle(
                      r + F.round((l - this.minx) * (k / t)),
                      n + F.round(E - E * ((this.maxyorg - this.miny) / e)),
                      M,
                      z,
                      T.get("maxSpotColor")
                    ).append())),
        ...
        (P.fn.sparkline.bar = q = e(P.fn.sparkline._base, r, {
          type: "bar",
          init: function (t, e, i, n, r) {
            var s,
              o,
              ...
              D = i.get("chartRangeClip"),
              M = 1 / 0,
              N = -1 / 0;
            for (
              q._super.init.call(this, t, e, i, n, r), R = 0, j = e.length;
              R < j;
              R++
            )
              ((s = "string" == typeof (x = e[R]) && -1 < x.indexOf(":")) ||
                P.isArray(x)) &&
                ((v = !0),
                s && (x = e[R] = I(x.split(":"))),
                (x = W(x, null)),
                (o = F.min.apply(F, x)) < M && (M = o),
                N < (a = F.max.apply(F, x)) && (N = a));
            (this.stacked = v),
              (this.regionShapes = {}),
              (this.barWidth = T),
              (this.barSpacing = S),
              (this.totalBarWidth = T + S),
              (this.width = n = e.length * T + (e.length - 1) * S),
              this.initTarget(),
              D && ((g = k === z ? -1 / 0 : k), (m = E === z ? 1 / 0 : E)),
              (h = []),
              (l = v ? [] : h);
            for (var O = [], A = [], R = 0, j = e.length; R < j; R++)
              if (v)
                for (
                  y = e[R],
                    e[R] = b = [],
                ...
                (x = D ? L(e[R], g, m) : e[R]),
                  null !== (x = e[R] = H(x)) && h.push(x);
            (this.max = p = F.max.apply(F, h)),
              (this.min = f = F.min.apply(F, h)),
              (this.stackMax = N = v ? F.max.apply(F, O) : p),
              (this.stackMin = M = v ? F.min.apply(F, h) : f),
              i.get("chartRangeMin") !== z &&
                (i.get("chartRangeClip") || i.get("chartRangeMin") < f) &&
                (f = i.get("chartRangeMin")),
              i.get("chartRangeMax") !== z &&
                (i.get("chartRangeClip") || i.get("chartRangeMax") > p) &&
                (p = i.get("chartRangeMax")),
              (this.zeroAxis = c = i.get("zeroAxis", !0)),
              (d = f <= 0 && 0 <= p && c ? 0 : 0 == c || 0 < f ? f : p),
              (this.xaxisOffset = d),
              (u = v ? F.max.apply(F, l) + F.max.apply(F, A) : p - f),
              (this.canvasHeightEf =
                c && f < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1),
              f < d
                ? (C =
                    (((v && 0 <= p ? N : p) - d) / u) * this.canvasHeight) !==
                    F.ceil(C) && ((this.canvasHeightEf -= 2), (C = F.ceil(C)))
                : (C = this.canvasHeight),
              (this.yoffset = C),
              P.isArray(i.get("colorMap"))
                ...
                : ((this.colorMapByIndex = null),
                  ...
                  this.colorMapByValue &&
                    ...
                    (this.colorMapByValue = new Y(this.colorMapByValue))),
              (this.range = u);
          },
          getRegion: function (t, e, i) {
            var n = F.floor(e / this.totalBarWidth);
            return n < 0 || n >= this.values.length ? z : n;
          },
          getCurrentRegionFields: function () {
            for (
              var t,
          ...
          calcColor: function (t, e, i) {
            var n,
              ...
              a = this.stacked
                ...
                : o.get("barColor");
            return (
              0 === e && o.get("zeroColor") !== z && (a = o.get("zeroColor")),
              s && (n = s.get(e)) ? (a = n) : r && r.length > i && (a = r[i]),
              P.isArray(a) ? a[t % a.length] : a
            );
          },
          renderRegion: function (t, e) {
            var i,
              ...
              f = this.stacked,
              p = this.target,
              g = t * this.totalBarWidth,
              m = this.canvasHeightEf,
              v = this.yoffset,
              y = (l = P.isArray(l) ? l : [l]).length,
              _ = l[0],
              w = x(null, l),
              b = x(u, l, !0);
            if (w)
              return h.get("nullColor")
                ? ((r = e
                    ? h.get("nullColor")
                    : this.calcHighlightColor(h.get("nullColor"), h)),
                  (i = 0 < v ? v - 1 : v),
                  p.drawRect(g, i, this.barWidth - 1, 0, r, r))
                : z;
            for (s = v, o = 0; o < y; o++) {
              if (((_ = l[o]), f && _ === u)) {
                if (!b || a) continue;
              ...
              (n = 0 < d ? F.floor(m * (F.abs(_ - u) / d)) + 1 : 1),
                _ < u || (_ === u && 0 === v)
                  ? ((i = s), (s += n))
                  : ((i = v - n), (v -= n)),
                (r = this.calcColor(o, _, t)),
                e && (r = this.calcHighlightColor(r, h)),
                c.push(p.drawRect(g, i, this.barWidth - 1, n - 1, r, r));
            }
            return 1 === c.length ? c[0] : c;
          },
        })),
        (P.fn.sparkline.tristate = a = e(P.fn.sparkline._base, r, {
          type: "tristate",
          init: function (t, e, i, n, r) {
            var s = parseInt(i.get("barWidth"), 10),
              o = parseInt(i.get("barSpacing"), 10);
            a._super.init.call(this, t, e, i, n, r),
              (this.regionShapes = {}),
              (this.barWidth = s),
              (this.barSpacing = o),
              (this.totalBarWidth = s + o),
              (this.values = P.map(e, Number)),
              (this.width = n = e.length * s + (e.length - 1) * o),
              P.isArray(i.get("colorMap"))
                ? ((this.colorMapByIndex = i.get("colorMap")),
                  (this.colorMapByValue = null))
                : ((this.colorMapByIndex = null),
            ...
            var i,
              ...
              h =
                n[t] < 0
                  ...
                  ? ((i = 0), a - 1)
                  : ((i = a - 1), 2),
              u = this.calcColor(n[t], t);
            if (null !== u)
              return (
                e && (u = this.calcHighlightColor(u, r)),
                s.drawRect(l, i, this.barWidth - 1, h - 1, u, u)
              );
          },
        })),
        (P.fn.sparkline.discrete = o = e(P.fn.sparkline._base, r, {
          type: "discrete",
          init: function (t, e, i, n, r) {
            o._super.init.call(this, t, e, i, n, r),
              (this.regionShapes = {}),
              (this.values = e = P.map(e, Number)),
              (this.min = F.min.apply(F, e)),
              (this.max = F.max.apply(F, e)),
              (this.range = this.max - this.min),
              (this.width = n =
                "auto" === i.get("width") ? 2 * e.length : this.width),
              (this.interval = F.floor(n / e.length)),
              (this.itemWidth = n / e.length),
              i.get("chartRangeMin") !== z &&
          ...
          renderRegion: function (t, e) {
            var i = this.values,
              ...
              p = F.round(c - ((d - r) / o) * c),
              g =
                n.get("thresholdColor") && d < n.get("thresholdValue")
                  ? n.get("thresholdColor")
                  : n.get("lineColor");
            return (
              e && (g = this.calcHighlightColor(g, n)),
              l.drawLine(f, p, f, p + u, g)
            );
          },
        })),
        (P.fn.sparkline.bullet = l = e(P.fn.sparkline._base, {
          type: "bullet",
          init: function (t, e, i, n, r) {
            var s, o, a;
            l._super.init.call(this, t, e, i, n, r),
              (this.values = e = I(e)),
              ((a = e.slice())[0] = null === a[0] ? a[2] : a[0]),
              (a[1] = null === e[1] ? a[2] : a[1]),
              (s = F.min.apply(F, e)),
              (o = F.max.apply(F, e)),
              (s = i.get("base") === z ? (s < 0 ? s : 0) : i.get("base")),
              (this.min = s),
              (this.max = o),
              (this.range = o - s),
              (this.shapes = {}),
              (this.valueShapes = {}),
              (this.regiondata = {}),
              (this.width = n = "auto" === i.get("width") ? "4.0em" : n),
              (this.target = this.$el.simpledraw(n, r, i.get("composite"))),
              e.length || (this.disabled = !0),
              this.initTarget();
          },
          getRegion: function (t, e, i) {
            var n = this.target.getShapeAt(t, e, i);
            return n !== z && this.shapes[n] !== z ? this.shapes[n] : z;
          },
          getCurrentRegionFields: function () {
            var t = this.currentRegion;
            return {
          ...
          changeHighlight: function (t) {
            ...
            (this.valueShapes[i] = e.id),
              (this.shapes[e.id] = i),
              this.target.replaceWithShape(n, e);
          },
          renderRange: function (t, e) {
            var i = this.values[t],
              n = F.round(this.canvasWidth * ((i - this.min) / this.range)),
          ...
          renderTarget: function (t) {
            var e = this.values[0],
              ...
              n = F.round(0.1 * this.canvasHeight),
        ...
        (P.fn.sparkline.pie = h = e(P.fn.sparkline._base, {
          type: "pie",
          init: function (t, e, i, n, r) {
            var s,
              o = 0;
            if (
              (h._super.init.call(this, t, e, i, n, r),
              (this.shapes = {}),
              (this.valueShapes = {}),
              (this.values = e = P.map(e, Number)),
          ...
          changeHighlight: function (t) {
            ...
            delete this.shapes[n],
              this.target.replaceWithShape(n, i),
          ...
          renderSlice: function (t, e) {
            for (
              ...
              if (((n = i = f), 0 < d && (n = f + u * (c[g] / d)), t === g))
                return (
                  (r = o.get("sliceColors")[g % o.get("sliceColors").length]),
                  e && (r = this.calcHighlightColor(r, o)),
                  s.drawPieSlice(a, a, a - l, i, n, z, r)
                );
              f = n;
            }
          },
        ...
        (P.fn.sparkline.box = b = e(P.fn.sparkline._base, {
          type: "box",
          init: function (t, e, i, n, r) {
            b._super.init.call(this, t, e, i, n, r),
              (this.values = P.map(e, Number)),
              (this.width = "auto" === i.get("width") ? "4.0em" : n),
              this.initTarget(),
          ...
          render: function () {
            ...
            if (b._super.render.call(this)) {
              if (p.get("raw"))
                ...
                for (t = o = z, l = 0; l < f; l++)
                  t === z && d[l] > n - i * p.get("outlierIQR") && (t = d[l]),
                    d[l] < s + i * p.get("outlierIQR") && (o = d[l]);
                (e = d[0]), (a = d[f - 1]);
              } else (t = d[0]), (o = d[f - 1]);
              (this.quartiles = [n, r, s]),
                (this.lwhisker = t),
                (this.rwhisker = o),
                (this.loutlier = e),
                (this.routlier = a),
                (u = g / (y - v + 1)),
                p.get("showOutliers") &&
                  ((_ = F.ceil(p.get("spotRadius"))),
                  (u = (g -= 2 * F.ceil(p.get("spotRadius"))) / (y - v + 1)),
                  e < t &&
                    c
                      .drawCircle(
                        (e - v) * u + _,
                ...
                c
                  ...
                  .append(),
                p.get("target") &&
                  ((h = F.ceil(p.get("spotRadius"))),
                  c
                    .drawLine(
                      F.round((p.get("target") - v) * u + _),
                      F.round(m / 2 - h),
                      F.round((p.get("target") - v) * u + _),
                      F.round(m / 2 + h),
                      p.get("targetColor")
        ...
        (p = e({
          ...
          drawPieSlice: function (t, e, i, n, r, s, o) {
            return this._genShape("PieSlice", [t, e, i, n, r, s, o]);
          },
          ...
          _calculatePixelDims: function (t, e, i) {
            var n = this._pxregex.exec(e);
            (this.pixelHeight = n ? n[1] : P(i).height()),
              (n = this._pxregex.exec(t)),
              (this.pixelWidth = n ? n[1] : P(i).width());
          },
          _genShape: function (t, e) {
            var i = C++;
            return e.unshift(i), new f(this, i, t, e);
          },
        ...
        (g = e(p, {
          ...
          _drawShape: function (t, e, i, n, r) {
            var s,
              o,
              a = this._getContext(i, n, r);
            for (
              a.beginPath(),
                a.moveTo(e[0][0] + 0.5, e[0][1] + 0.5),
                s = 1,
                o = e.length;
              s < o;
              s++
            )
              a.lineTo(e[s][0] + 0.5, e[s][1] + 0.5);
            i !== z && a.stroke(),
              n !== z && a.fill(),
              this.targetX !== z &&
                this.targetY !== z &&
          ...
          _drawCircle: function (t, e, i, n, r, s, o) {
            var a = this._getContext(r, s, o);
            a.beginPath(),
              a.arc(e, i, n, 0, 2 * F.PI, !1),
              this.targetX !== z &&
                this.targetY !== z &&
                a.isPointInPath(this.targetX, this.targetY) &&
                (this.currentTargetShapeId = t),
          ...
          _drawPieSlice: function (t, e, i, n, r, s, o, a) {
            var l = this._getContext(o, a);
            l.beginPath(),
              l.moveTo(e, i),
              l.arc(e, i, n, r, s, !1),
              l.lineTo(e, i),
          ...
          _drawRect: function (t, e, i, n, r, s, o) {
          ...
          replaceWithShape: function (t, e) {
            var i,
              n = this.shapeseq;
            for (this.shapes[e.id] = e, i = n.length; i--; )
              n[i] == t && (n[i] = e.id);
            delete this.shapes[t];
          },
          replaceWithShapes: function (t, e) {
            for (var i, n, r = this.shapeseq, s = {}, o = t.length; o--; )
              s[t[o]] = !0;
            for (o = r.length; o--; )
              s[(i = r[o])] && (r.splice(o, 1), delete this.shapes[i], (n = o));
            for (o = e.length; o--; )
              r.splice(n, 0, e[o].id), (this.shapes[e[o].id] = e[o]);
          },
          insertAfterShape: function (t, e) {
            for (var i = this.shapeseq, n = i.length; n--; )
              if (i[n] === t)
                return i.splice(n + 1, 0, e.id), void (this.shapes[e.id] = e);
          },
          removeShapeId: function (t) {
          ...
          render: function () {
            ...
            for (
              ...
              this["_draw" + (t = n[i[e]]).type].apply(this, t.args);
        ...
        (m = e(p, {
          init: function (t, e, i) {
            ...
            m._super.init.call(this, t, e, i),
              ...
              (this.group = P(this.canvas).children()[0]),
              (this.rendered = !1),
              (this.prerender = "");
          },
          _drawShape: function (t, e, i, n, r) {
            for (var s, o, a, l, h = [], u = 0, c = e.length; u < c; u++)
              h[u] = e[u][0] + "," + e[u][1];
            return (
              (s = h.splice(0, 1)),
              (r = r === z ? 1 : r),
          ...
          _drawCircle: function (t, e, i, n, r, s, o) {
            return (
              ...
              (r === z
                ? ' stroked="false" '
                : ' strokeWeight="' + o + 'px" strokeColor="' + r + '" ') +
              (s === z
                ? ' filled="false"'
          ...
          _drawPieSlice: function (t, e, i, n, r, s, o, a) {
            ...
            if (r === s) return "";
            if (
              (s - r == 2 * F.PI && ((r = 0), (s = 2 * F.PI)),
              (h = e + F.round(F.cos(r) * n)),
              (u = i + F.round(F.sin(r) * n)),
              (c = e + F.round(F.cos(s) * n)),
              (d = i + F.round(F.sin(s) * n)),
              h === c && u === d)
            ) {
              if (s - r < F.PI) return "";
              (h = c = e + n), (u = d = i);
            }
            return h === c && u === d && s - r < F.PI
              ? ""
              : ((l = [e - n, i - n, e + n, i + n, h, u, c, d]),
                (f =
                  o === z
                    ? ' stroked="false" '
          ...
          replaceWithShapes: function (t, e) {
            for (
              var i = P("#jqsshape" + t[0]), n = "", r = e.length, s = 0;
              s < r;
              s++
            )
              n += this["_draw" + e[s].type].apply(this, e[s].args);
            for (i[0].outerHTML = n, s = 1; s < t.length; s++)
              P("#jqsshape" + t[s]).remove();
          },
          insertAfterShape: function (t, e) {
            var i = P("#jqsshape" + t),
              n = this["_draw" + e.type].apply(this, e.args);
  ...
  (function (t, e) {
    ...
    function x(t) {
      var e = v(NaN);
      return null != t ? m(b(e), t) : (b(e).userInvalidated = !0), e;
    }
    ...
    var s = (_.momentProperties = []),
      e = !1;
    function C(t, e) {
      var i, n, r;
      if (
        (d(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject),
        d(e._i) || (t._i = e._i),
        d(e._f) || (t._f = e._f),
        d(e._l) || (t._l = e._l),
        ...
        for (i = 0; i < s.length; i++) d((r = e[(n = s[i])])) || (t[n] = r);
      return t;
    }
    function T(t) {
      C(this, t),
        ...
        !1 === e && ((e = !0), _.updateOffset(this), (e = !1));
    }
    function S(t) {
    ...
    function i(r, s) {
      ...
      return m(function () {
        if (
          (null != _.deprecationHandler && _.deprecationHandler(null, r), o)
        ) {
          for (var t, e, i = [], n = 0; n < arguments.length; n++) {
            if (((t = ""), "object" == typeof arguments[n])) {
              for (e in ((t += "\n[" + n + "] "), arguments[0]))
                w(arguments[0], e) && (t += e + ": " + arguments[0][e] + ", ");
              t = t.slice(0, -2);
            } else t = arguments[n];
            i.push(t);
          }
    ...
    var n,
      o = {};
    function h(t, e) {
      null != _.deprecationHandler && _.deprecationHandler(t, e),
        o[t] || (l(e), (o[t] = !0));
    }
    function k(t) {
      return (
      ...
      for (i in e)
        w(e, i) &&
          (c(t[i]) && c(e[i])
            ...
            ? (n[i] = e[i])
            : delete n[i]);
      for (i in t) w(t, i) && !w(e, i) && c(t[i]) && (n[i] = m({}, n[i]));
      return n;
    }
    function D(t) {
      null != t && this.set(t);
    ...
    function j(t, e, i, n) {
      ...
      t && (R[t] = r),
        e &&
          (R[e[0]] = function () {
            return M(r.apply(this, arguments), e[1], e[2]);
          }),
        i &&
          (R[i] = function () {
      ...
      return t.isValid()
        ? ((e = L(e, t.localeData())),
          (A[e] =
            A[e] ||
            (function (n) {
              for (var t, r = n.match(N), e = 0, s = r.length; e < s; e++)
                R[r[e]]
                  ? (r[e] = R[r[e]])
                  : (r[e] = (t = r[e]).match(/\[[\s\S]/)
                      ? t.replace(/^\[|\]$/g, "")
    ...
    function L(t, e) {
      ...
      for (O.lastIndex = 0; 0 <= i && O.test(t); )
        (t = t.replace(O, n)), (O.lastIndex = 0), --i;
      return t;
    }
    var H = {};
    function I(t, e) {
    ...
    function Y(t) {
      var e,
        i,
        n = {};
      for (i in t) w(t, i) && (e = W(i)) && (n[e] = t[i]);
      return n;
    }
    var q = {};
    function F(t, e) {
    ...
    function V(e, i) {
      return function (t) {
        return null != t
          ? (G(this, e, t), _.updateOffset(this, i), this)
          : U(this, e);
      };
    }
    function U(t, e) {
    ...
    function G(t, e, i) {
      t.isValid() &&
        !isNaN(i) &&
        ("FullYear" === e && z(t.year()) && 1 === t.month() && 29 === t.date()
          ? ((i = B(i)),
    ...
    function Et(t, e) {
      ...
      var i = ((e % 12) + 12) % 12;
      return (
        (t += (e - i) / 12), 1 == i ? (z(t) ? 29 : 28) : 31 - ((i % 7) % 2)
      );
    }
    (vt = Array.prototype.indexOf
      ...
      gt(["MMM", "MMMM"], function (t, e, i, n) {
        ...
        null != r ? (e[_t] = r) : (b(i).invalidMonth = t);
      });
    var Dt = "January_February_March_April_May_June_July_August_September_October_November_December".split(
        "_"
      ),
    ...
    function jt(t) {
      return null != t
        ? (Rt(this, t), _.updateOffset(this, !0), this)
        : U(this, "Month");
    }
    function Pt() {
      function t(t, e) {
      ...
      for (var e, i = [], n = [], r = [], s = 0; s < 12; s++)
        (e = v([2e3, s])),
          i.push(this.monthsShort(e, "")),
          n.push(this.months(e, "")),
          r.push(this.months(e, "")),
          r.push(this.monthsShort(e, ""));
      for (i.sort(t), n.sort(t), r.sort(t), s = 0; s < 12; s++)
        (i[s] = ft(i[s])), (n[s] = ft(n[s]));
      for (s = 0; s < 24; s++) r[s] = ft(r[s]);
    ...
    j("Y", 0, 0, function () {
      ...
      gt("YYYY", function (t, e) {
        e[yt] = 2 === t.length ? _.parseTwoDigitYear(t) : B(t);
      }),
      gt("YY", function (t, e) {
        e[yt] = _.parseTwoDigitYear(t);
      }),
      gt("Y", function (t, e) {
        e[yt] = parseInt(t, 10);
      }),
    ...
    function Wt(t, e, i) {
      var n = 7 + e - i;
      return n - ((7 + It(t, 0, n).getUTCDay() - e) % 7) - 1;
    }
    function Yt(t, e, i, n, r) {
      var s,
        o = 1 + 7 * (e - 1) + ((7 + i - n) % 7) + Wt(t, n, r),
        a =
          o <= 0
            ? Lt((s = t - 1)) + o
            : o > Lt(t)
    ...
    function qt(t, e, i) {
      ...
      return (
        o < 1
          ? (n = o + Ft((r = t.year() - 1), e, i))
          : o > Ft(t.year(), e, i)
          ? ((n = o - Ft(t.year(), e, i)), (r = t.year() + 1))
          : ((r = t.year()), (n = o)),
        { week: n, year: r }
      );
    }
    ...
    j("w", ["ww", 2], "wo", "week"),
      ...
      mt(["dd", "ddd", "dddd"], function (t, e, i, n) {
        ...
        null != r ? (e.d = r) : (b(i).invalidWeekday = t);
      }),
    ...
    function Xt() {
      ...
      for (var e, i, n, r, s = [], o = [], a = [], l = [], h = 0; h < 7; h++)
        (e = v([2e3, 1]).day(h)),
    ...
    j("H", ["HH", 2], 0, "hour"),
      ...
      gt("Hmm", function (t, e, i) {
        var n = t.length - 2;
        (e[bt] = B(t.substr(0, n))), (e[xt] = B(t.substr(n)));
      }),
      gt("Hmmss", function (t, e, i) {
        var n = t.length - 4,
          r = t.length - 2;
    ...
    function he(t) {
      ...
      return (function (t) {
        for (var e, i, n, r, s = 0; s < t.length; ) {
          for (
            e = (r = se(t[s]).split("-")).length,
              i = (i = se(t[s + 1])) ? i.split("-") : null;
            0 < e;
      ...
      return (
        i &&
          ...
          ((e =
            i[_t] < 0 || 11 < i[_t]
              ? _t
              : i[wt] < 1 || i[wt] > Et(i[yt], i[_t])
              ? wt
              : i[bt] < 0 ||
                24 < i[bt] ||
                (24 === i[bt] && (0 !== i[xt] || 0 !== i[Ct] || 0 !== i[Tt]))
              ? bt
              : i[xt] < 0 || 59 < i[xt]
              ? xt
              : i[Ct] < 0 || 59 < i[Ct]
              ...
              ? Tt
              : -1),
          b(t)._overflowDayOfYear && (e < yt || wt < e) && (e = wt),
          b(t)._overflowWeeks && -1 === e && (e = St),
          b(t)._overflowWeekday && -1 === e && (e = kt),
          (b(t).overflow = e)),
        t
      );
    }
    ...
    function _e(t) {
      var e,
        ...
        o,
        a = t._i,
        l = ce.exec(a) || de.exec(a);
      if (l) {
        for (b(t).iso = !0, e = 0, i = pe.length; e < i; e++)
          if (pe[e][1].exec(l[1])) {
            (r = pe[e][0]), (n = !1 !== pe[e][2]);
            break;
          }
        if (null == r) return (t._isValid = !1);
        if (l[3]) {
          ...
          if (null == s) return (t._isValid = !1);
        }
        if (!n && null != s) return (t._isValid = !1);
        if (l[4]) {
          if (!fe.exec(l[4])) return (t._isValid = !1);
          o = "Z";
        }
        (t._f = r + (s || "") + (o || "")), Ce(t);
      } else t._isValid = !1;
    ...
    function we(t) {
      ...
      if (f) {
        if (
          ...
          (u = f[7]),
          (d = [
            (c = parseInt(s, 10)) <= 49 ? 2e3 + c : c <= 999 ? 1900 + c : c,
            Mt.indexOf(o),
            parseInt(a, 10),
            parseInt(l, 10),
            parseInt(h, 10),
          ]),
          u && d.push(parseInt(u, 10)),
          (n = e = d),
          (r = t),
          (i = f[1]) &&
            Bt.indexOf(i) !== new Date(n[0], n[1], n[2]).getDay() &&
            ((b(r).weekdayMismatch = !0), !void (r._isValid = !1)))
        )
          return;
        (t._a = e),
      ...
      if (!t._d) {
        ...
        for (
          t._w &&
            null == t._a[wt] &&
            null == t._a[_t] &&
            (null != (o = (s = t)._w).GG || null != o.W || null != o.E
              ? ((u = 1),
                (c = 4),
                (a = be(o.GG, s._a[yt], qt(ke(), 1, 4).year)),
                (l = be(o.W, 1)),
                ((h = be(o.E, 1)) < 1 || 7 < h) && (f = !0))
              : ((u = s._locale._week.dow),
                (c = s._locale._week.doy),
                (p = qt(ke(), u, c)),
                (a = be(o.gg, s._a[yt], p.year)),
                (l = be(o.w, p.week)),
                null != o.d
                  ? ((h = o.d) < 0 || 6 < h) && (f = !0)
                  : null != o.e
                  ? ((h = o.e + u), (o.e < 0 || 6 < o.e) && (f = !0))
                  : (h = u)),
            l < 1 || l > Ft(a, u, c)
            ...
            null != t._dayOfYear &&
              ((r = be(t._a[yt], y[yt])),
              (t._dayOfYear > Lt(r) || 0 === t._dayOfYear) &&
                (b(t)._overflowDayOfYear = !0),
              (i = It(r, 0, t._dayOfYear)),
              (t._a[_t] = i.getUTCMonth()),
              (t._a[wt] = i.getUTCDate())),
            e = 0;
          e < 3 && null == t._a[e];
          ++e
        )
          t._a[e] = g[e] = y[e];
        for (; e < 7; e++)
          t._a[e] = g[e] = null == t._a[e] ? (2 === e ? 1 : 0) : t._a[e];
        24 === t._a[bt] &&
          0 === t._a[xt] &&
          0 === t._a[Ct] &&
          0 === t._a[Tt] &&
          ...
          (t._d = (t._useUTC
            ...
            : function (t, e, i, n, r, s, o) {
                ...
                return (
                  t < 100 && 0 <= t
                    ? ((a = new Date(t + 400, e, i, n, r, s, o)),
                      isFinite(a.getFullYear()) && a.setFullYear(t))
                    : (a = new Date(t, e, i, n, r, s, o)),
                  a
                );
              }
          ).apply(null, g)),
          ...
          for (
            ...
            (i = c[d]),
              (e = (l.match(
                ...
                (0 < (n = l.substr(0, l.indexOf(e))).length &&
                  b(t).unusedInput.push(n),
                (l = l.slice(l.indexOf(e) + e.length)),
                (u += e.length)),
              R[i]
                ? (e ? (b(t).empty = !1) : b(t).unusedTokens.push(i),
                  (s = i),
                  (a = t),
                  null != (o = e) && w(pt, s) && pt[s](o, a._a, a, s))
                : t._strict && !e && b(t).unusedTokens.push(i);
          (b(t).charsLeftOver = h - u),
            0 < l.length && b(t).unusedInput.push(l),
            t._a[bt] <= 12 &&
              !0 === b(t).bigHour &&
              0 < t._a[bt] &&
              (b(t).bigHour = void 0),
            ...
            (t._a[bt] =
              ...
              null == (g = t._meridiem)
                ...
                ? f.meridiemHour(p, g)
                : (null != f.isPM &&
                    ((m = f.isPM(g)) && p < 12 && (p += 12),
                    m || 12 !== p || (p = 0)),
                  p))),
            null !== (r = b(t).era) &&
              (t._a[yt] = t._locale.erasConvertYear(r, t._a[yt])),
            xe(t),
            ue(t);
        } else we(t);
      else _e(t);
            ...
            S(l)
              ...
              : (p(l)
                  ...
                  ? (function (t) {
                      ...
                      if (0 === t._f.length)
                        return (
                          (b(t).invalidFormat = !0), (t._d = new Date(NaN))
                        );
                      ...
                      ? (_e(o),
                        !1 === o._isValid &&
                          ...
                          !1 === o._isValid &&
                            ...
                            o._strict
                              ? (o._isValid = !1)
                              : _.createFromInputFallback(o))))
                      : (o._d = new Date(+a[1])))
                  : u(i)
                  ? ((e._a = g(i.slice(0), function (t) {
                      return parseInt(t, 10);
                    })),
                    xe(e))
                  : c(i)
                  ? (n = e)._d ||
                    ((s = void 0 === (r = Y(n._i)).day ? r.date : r.day),
                    (n._a = g(
                      [
                        r.year,
                        r.month,
    ...
    function Se(t, e, i, n, r) {
      ...
      return (
        ...
        ((c(t) && a(t)) || (u(t) && 0 === t.length)) && (t = void 0),
    ...
    var Ee = i(
      ...
      De = i(
        ...
        function () {
          var t = ke.apply(null, arguments);
          return this.isValid() && t.isValid() ? (this < t ? this : t) : x();
        }
      );
    function Me(t, e) {
      var i, n;
      if ((1 === e.length && u(e[0]) && (e = e[0]), !e.length)) return ke();
    ...
    function Oe(t) {
      ...
      (this._isValid = (function (t) {
        ...
        for (e in t)
          if (
            w(t, e) &&
            (-1 === vt.call(Ne, e) || (null != t[e] && isNaN(t[e])))
          )
            return !1;
        for (i = 0; i < Ne.length; ++i)
          if (t[Ne[i]]) {
            if (n) return !1;
            parseFloat(t[Ne[i]]) !== B(t[Ne[i]]) && (n = !0);
          }
        return !0;
      })(e)),
    ...
    function He(t, e) {
      ...
      return e._isUTC
        ? ((i = e.clone()),
          (n = (S(t) || p(t) ? t.valueOf() : ke(t).valueOf()) - i.valueOf()),
      ...
      return (
        Ae(t)
          ...
          : "object" == typeof l &&
            ...
            (r =
              s.isValid() && o.isValid()
                ? ((o = He(o, s)),
                  s.isBefore(o)
                    ? (a = $e(s, o))
                    : (((a = $e(o, s)).milliseconds = -a.milliseconds),
                      (a.months = -a.months)),
                  a)
            ...
            (l.M = r.months)),
        (n = new Oe(l)),
        Ae(t) && w(t, "_locale") && (n._locale = t._locale),
        Ae(t) && w(t, "_isValid") && (n._isValid = t._isValid),
        n
      );
    }
    function ze(t, e) {
    ...
    function Ve(t, e, i, n) {
      ...
      t.isValid() &&
        ((n = null == n || n),
        o && Rt(t, U(t, "Month") + o * i),
        s && G(t, "Date", U(t, "Date") + s * i),
        r && t._d.setTime(t._d.valueOf() + r * i),
        n && _.updateOffset(t, s || o));
    }
    (Fe.fn = Oe.prototype),
      (Fe.invalid = function () {
        return Fe(NaN);
    ...
    function si() {
      for (
        ...
        e.push(ft(r[s].name)),
          t.push(ft(r[s].abbr)),
          i.push(ft(r[s].narrow)),
          n.push(ft(r[s].name)),
          n.push(ft(r[s].abbr)),
          n.push(ft(r[s].narrow));
    ...
    j("N", 0, 0, "eraAbbr"),
      ...
      gt(["N", "NN", "NNN", "NNNN", "NNNNN"], function (t, e, i, n) {
        var r = i._locale.erasParse(t, n, i._strict);
        r ? (b(i).era = r) : (b(i).invalidEra = t);
      }),
      dt("y", at),
      dt("yy", at),
      dt("yyy", at),
    ...
    for (ui = "S"; ui.length <= 9; ui += "S") gt(ui, fi);
    (ci = V("Milliseconds", !1)),
      j("z", 0, 0, "zoneAbbr"),
      j("zz", 0, 0, "zoneName");
    var pi = T.prototype;
    ...
    (pi.add = Ue),
      (pi.calendar = function (t, e) {
        ...
        var i = t || ke(),
          ...
          r = _.calendarFormat(this, n) || "sameElse",
          s = e && (k(e[r]) ? e[r].call(this, i) : e[r]);
        return this.format(s || this.localeData().calendar(r, this, ke(i)));
      }),
      (pi.clone = function () {
        return new T(this);
      }),
      (pi.diff = function (t, e, i) {
        var n, r, s;
        if (!this.isValid()) return NaN;
        if (!(n = He(t, this)).isValid()) return NaN;
        switch (((r = 6e4 * (n.utcOffset() - this.utcOffset())), (e = W(e)))) {
          case "year":
            s = Ze(this, n) / 12;
            break;
          case "month":
        ...
        switch (((i = this._isUTC ? ni : ii), t)) {
          ...
          case "hour":
            (e = this._d.valueOf()),
              (e +=
                36e5 -
                ei(e + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5) -
                1);
            break;
          case "minute":
            (e = this._d.valueOf()), (e += 6e4 - ei(e, 6e4) - 1);
            break;
          case "second":
            (e = this._d.valueOf()), (e += 1e3 - ei(e, 1e3) - 1);
        }
        return this._d.setTime(e), _.updateOffset(this, !0), this;
      }),
      (pi.format = function (t) {
        t = t || (this.isUtc() ? _.defaultFormatUtc : _.defaultFormat);
        var e = P(this, t);
        return this.localeData().postformat(e);
      }),
      (pi.from = function (t, e) {
        return this.isValid() && ((S(t) && t.isValid()) || ke(t).isValid())
          ? Fe({ to: this, from: t }).locale(this.locale()).humanize(!e)
          : this.localeData().invalidDate();
      }),
      (pi.fromNow = function (t) {
      ...
      (pi.get = function (t) {
        return k(this[(t = W(t))]) ? this[t]() : this;
      }),
      (pi.invalidAt = function () {
        return b(this).overflow;
      }),
      (pi.isAfter = function (t, e) {
        var i = S(t) ? t : ke(t);
        return (
      ...
      (pi.isSameOrAfter = function (t, e) {
        return this.isSame(t, e) || this.isAfter(t, e);
      }),
      (pi.isSameOrBefore = function (t, e) {
      ...
      (pi.set = function (t, e) {
        if ("object" == typeof t)
          for (
            var i = (function (t) {
                var e,
                  i = [];
                for (e in t) w(t, e) && i.push({ unit: e, priority: q[e] });
                return (
                  i.sort(function (t, e) {
        ...
        else if (k(this[(t = W(t))])) return this[t](e);
        return this;
      }),
      (pi.startOf = function (t) {
        var e, i;
        if (void 0 === (t = W(t)) || "millisecond" === t || !this.isValid())
          return this;
        switch (((i = this._isUTC ? ni : ii), t)) {
          ...
          case "hour":
            (e = this._d.valueOf()),
              (e -= ei(e + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5));
            break;
          case "minute":
            (e = this._d.valueOf()), (e -= ei(e, 6e4));
            break;
          case "second":
            (e = this._d.valueOf()), (e -= ei(e, 1e3));
        }
        return this._d.setTime(e), _.updateOffset(this, !0), this;
      }),
      (pi.subtract = Ge),
      ...
      "undefined" != typeof Symbol &&
        null != Symbol.for &&
        (pi[Symbol.for("nodejs.util.inspect.custom")] = function () {
      ...
      (pi.eraName = function () {
        for (
          var t, e = this.localeData().eras(), i = 0, n = e.length;
          i < n;
          ++i
        ) {
          if (
      ...
      (pi.eraYear = function () {
        for (
          var t, e, i = this.localeData().eras(), n = 0, r = i.length;
          n < r;
          ++n
        )
          if (
            ...
            (i[n].since <= e && e <= i[n].until) ||
              (i[n].until <= e && e <= i[n].since))
          )
            return (this.year() - _(i[n].since).year()) * t + i[n].offset;
        return this.year();
      }),
      (pi.year = Ht),
      (pi.isLeapYear = function () {
        return z(this.year());
      }),
      (pi.weekYear = function (t) {
        return ai.call(
          this,
          t,
          this.week(),
      ...
      (pi.isoWeekYear = function (t) {
        return ai.call(this, t, this.isoWeek(), this.isoWeekday(), 1, 4);
      }),
      (pi.quarter = pi.quarters = function (t) {
        return null == t
          ? Math.ceil((this.month() + 1) / 3)
          : this.month(3 * (t - 1) + (this.month() % 3));
      }),
      (pi.month = jt),
      (pi.daysInMonth = function () {
        return Et(this.year(), this.month());
      }),
      (pi.week = pi.weeks = function (t) {
        var e = this.localeData().week(this);
        return null == t ? e : this.add(7 * (t - e), "d");
      }),
      (pi.isoWeek = pi.isoWeeks = function (t) {
        var e = qt(this, 1, 4).week;
        return null == t ? e : this.add(7 * (t - e), "d");
      }),
      (pi.weeksInYear = function () {
        var t = this.localeData()._week;
        return Ft(this.year(), t.dow, t.doy);
      }),
      (pi.weeksInWeekYear = function () {
        var t = this.localeData()._week;
        return Ft(this.weekYear(), t.dow, t.doy);
      }),
      (pi.isoWeeksInYear = function () {
        return Ft(this.year(), 1, 4);
      }),
      (pi.isoWeeksInISOWeekYear = function () {
        return Ft(this.isoWeekYear(), 1, 4);
      }),
      (pi.date = li),
      (pi.day = pi.days = function (t) {
      ...
      (pi.weekday = function (t) {
        if (!this.isValid()) return null != t ? this : NaN;
        var e = (this.day() + 7 - this.localeData()._week.dow) % 7;
        return null == t ? e : this.add(t - e, "d");
      }),
      (pi.isoWeekday = function (t) {
        if (!this.isValid()) return null != t ? this : NaN;
      ...
      (pi.second = pi.seconds = di),
      (pi.millisecond = pi.milliseconds = ci),
      (pi.utcOffset = function (t, e, i) {
        var n,
          r = this._offset || 0;
        if (!this.isValid()) return null != t ? this : NaN;
        if (null == t) return this._isUTC ? r : Ie(this);
        if ("string" == typeof t) {
      ...
      (pi.parseZone = function () {
        var t;
        return (
          null != this._tzm
            ? this.utcOffset(this._tzm, !1, !0)
            : "string" == typeof this._i &&
              (null != (t = Le(ht, this._i))
                ? this.utcOffset(t)
                : this.utcOffset(0, !0)),
          this
        );
      }),
      (pi.hasAlignedHourOffset = function (t) {
        return (
          !!this.isValid() &&
      ...
      (pi.isUtcOffset = function () {
        return !!this.isValid() && this._isUTC;
      }),
      (pi.isUtc = We),
      (pi.isUTC = We),
      (pi.zoneAbbr = function () {
        return this._isUTC ? "UTC" : "";
      }),
      (pi.zoneName = function () {
        return this._isUTC ? "Coordinated Universal Time" : "";
      }),
      (pi.dates = i("dates accessor is deprecated. Use date instead.", li)),
      (pi.months = i("months accessor is deprecated. Use month instead", jt)),
      (pi.years = i("years accessor is deprecated. Use year instead", Ht)),
      (pi.zone = i(
    ...
    function yi(t, e, i) {
      ...
      for (var n = [], r = 0; r < 12; r++) n[r] = vi(t, r, i, "month");
      return n;
    }
    function _i(t, e, i, n) {
      "boolean" == typeof t
        ? f(e) && ((i = e), (e = void 0))
        : ((e = t), (t = !1), f((i = e)) && ((i = e), (e = void 0))),
        (e = e || "");
      var r,
        s = he(),
        o = t ? s._week.dow : 0,
        a = [];
      if (null != i) return vi(e, (i + o) % 7, n, "day");
      for (r = 0; r < 7; r++) a[r] = vi(e, (r + o) % 7, n, "day");
      return a;
    }
    (mi.calendar = function (t, e, i) {
      ...
      (mi.relativeTime = function (t, e, i, n) {
        ...
        return k(r) ? r(t, e, i, n) : r.replace(/%d/i, t);
      }),
      ...
      (mi.set = function (t) {
        var e, i;
        for (i in t)
          w(t, i) && (k((e = t[i])) ? (this[i] = e) : (this["_" + i] = e));
        (this._config = t),
      ...
      (mi.eras = function (t, e) {
        for (
          var i, n = this._eras || he("en")._eras, r = 0, s = n.length;
          r < s;
          ++r
        ) {
          switch (typeof n[r].since) {
            case "string":
              (i = _(n[r].since).startOf("day")), (n[r].since = i.valueOf());
          }
          switch (typeof n[r].until) {
            case "undefined":
              ...
              break;
            case "string":
              (i = _(n[r].until).startOf("day").valueOf()),
                (n[r].until = i.valueOf());
          }
        }
        return n;
      ...
      (mi.erasParse = function (t, e, i) {
        var n,
          ...
          a,
          l = this.eras();
        for (t = t.toUpperCase(), n = 0, r = l.length; n < r; ++n)
          if (
            ((s = l[n].name.toUpperCase()),
      ...
      (mi.months = function (t, e) {
        return t
          ? u(this._months)
            ...
            : this._months[
                (this._months.isFormat || Nt).test(e) ? "format" : "standalone"
              ][t.month()]
          : u(this._months)
          ? this._months
      ...
      (mi.monthsShort = function (t, e) {
        return t
          ? u(this._monthsShort)
            ...
            : this._monthsShort[Nt.test(e) ? "format" : "standalone"][t.month()]
          : u(this._monthsShort)
          ? this._monthsShort
      ...
      (mi.monthsParse = function (t, e, i) {
        ...
        if (this._monthsParseExact)
          return function (t, e, i) {
            ...
            return i
              ? "MMM" === e
                ? -1 !== (r = vt.call(this._shortMonthsParse, o))
                  ? r
                  : null
                : -1 !== (r = vt.call(this._longMonthsParse, o))
                ? r
                : null
              : "MMM" === e
              ? -1 !== (r = vt.call(this._shortMonthsParse, o)) ||
      ...
      (mi.monthsRegex = function (t) {
        return this._monthsParseExact
          ? (w(this, "_monthsRegex") || Pt.call(this),
            t ? this._monthsStrictRegex : this._monthsRegex)
          : (w(this, "_monthsRegex") || (this._monthsRegex = At),
      ...
      (mi.monthsShortRegex = function (t) {
        return this._monthsParseExact
          ...
          : (w(this, "_monthsShortRegex") || (this._monthsShortRegex = Ot),
      ...
      (mi.weekdaysParse = function (t, e, i) {
        ...
        if (this._weekdaysParseExact)
          return function (t, e, i) {
            ...
            return i
              ? "dddd" === e
                ? -1 !== (r = vt.call(this._weekdaysParse, o))
                  ? r
                  : null
                : "ddd" === e
                ? -1 !== (r = vt.call(this._shortWeekdaysParse, o))
                  ? r
                  : null
                : -1 !== (r = vt.call(this._minWeekdaysParse, o))
                ? r
                : null
              : "dddd" === e
              ? -1 !== (r = vt.call(this._weekdaysParse, o)) ||
      ...
      (mi.weekdaysRegex = function (t) {
        return this._weekdaysParseExact
          ? (w(this, "_weekdaysRegex") || Xt.call(this),
            t ? this._weekdaysStrictRegex : this._weekdaysRegex)
          : (w(this, "_weekdaysRegex") || (this._weekdaysRegex = Ut),
      ...
      (mi.weekdaysShortRegex = function (t) {
        return this._weekdaysParseExact
          ...
          : (w(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Gt),
      ...
      (mi.weekdaysMinRegex = function (t) {
        return this._weekdaysParseExact
          ...
          : (w(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Qt),
      ...
      (_.lang = i("moment.lang is deprecated. Use moment.locale instead.", ae)),
      (_.langData = i(
    ...
    var Li = Pi("milliseconds"),
      ...
      Fi = Pi("years"),
      zi = Math.round,
      $i = { ss: 44, s: 45, m: 45, h: 22, d: 26, w: null, M: 11 };
    var Bi = Math.abs;
    function Vi(t) {
      return (0 < t) - (t < 0) || +t;
    }
    function Ui() {
      ...
      return c
        ? ((t = $(l / 60)),
          ...
          (r = c < 0 ? "-" : ""),
          (s = Vi(this._months) !== Vi(c) ? "-" : ""),
          (o = Vi(this._days) !== Vi(c) ? "-" : ""),
          (a = Vi(this._milliseconds) !== Vi(c) ? "-" : ""),
          r +
            "P" +
            (i ? s + i + "Y" : "") +
            (u ? s + u + "M" : "") +
    ...
    return (
      ...
      (Gi.as = function (t) {
        ...
        if ("month" === (t = W(t)) || "quarter" === t || "year" === t)
          switch (
            ((e = this._days + n / 864e5), (i = this._months + Ci(e)), t)
          ) {
            case "month":
              return i;
            case "quarter":
      ...
      (_.localeData = he),
      (_.isDuration = Ae),
      (_.monthsShort = function (t, e) {
        return yi(t, e, "monthsShort");
      }),
      (_.weekdaysMin = function (t, e, i) {
        return _i(t, e, i, "weekdaysMin");
      }),
      (_.defineLocale = le),
      (_.updateLocale = function (t, e) {
        var i, n, r;
        return (
          null != e
            ? ((r = ie),
              null != ne[t] && null != ne[t].parentLocale
                ? ne[t].set(E(ne[t]._config, e))
                : (null != (n = oe(t)) && (r = n._config),
                  (e = E(r, e)),
                  null == n && (e.abbr = t),
            ...
            : null != ne[t] &&
              (null != ne[t].parentLocale
                ? ((ne[t] = ne[t].parentLocale), t === ae() && ae(t))
      ...
      (_.weekdaysShort = function (t, e, i) {
        return _i(t, e, i, "weekdaysShort");
      }),
      (_.normalizeUnits = W),
      (_.relativeTimeRounding = function (t) {
        return void 0 === t ? zi : "function" == typeof t && ((zi = t), !0);
      }),
      (_.relativeTimeThreshold = function (t, e) {
        return (
          void 0 !== $i[t] &&
          (void 0 === e
            ? $i[t]
  ...
  (function (l, i, r, a) {
    ...
    (h.Defaults = {
          ...
          run: function () {
            ...
            for (s /= 2; 0 < s; )
              t.push(this.normalize(t.length / 2, !0)),
                ...
                --s;
            (this._clones = t),
              l(o).addClass("cloned").appendTo(this.$stage),
          ...
          run: function () {
            for (
              ...
              (t = this._coordinates[a - 1] || 0),
                ...
                ((this.op(t, "<=", r) && this.op(t, ">", s)) ||
                  (this.op(e, "<", r) && this.op(e, ">", s))) &&
                  o.push(a);
        ...
        return (
          ...
          this.settings.loop ||
            (this.op(i, ">", o[this.minimum()])
              ? (r = i = this.minimum())
              : this.op(i, "<", o[this.maximum()]) && (r = i = this.maximum())),
          r
        );
      }),
      ...
      (h.prototype.destroy = function () {
        ...
        this.$stage.children(".cloned").remove(),
          ...
          this.$element
            ...
            .removeData("owl.start-online-classes");
      }),
      ...
      (h.prototype.trigger = function (t, e, i, n, r) {
      ...
      (l.fn.owlCarousel = function (e) {
        ...
        return this.each(function () {
          var t = l(this),
            i = t.data("owl.start-online-classes");
          i ||
            ((i = new h(this, "object" == typeof e && e)),
            t.data("owl.start-online-classes", i),
            l.each(
              [
                "next",
                "prev",
              ...
              function (t, e) {
                i.register({ type: h.Type.Event, name: e }),
                  i.$element.on(
                    e + ".owl.start-online-classes.core",
                    l.proxy(function (t) {
                      t.namespace &&
  ...
  (function (u, e) {
    ...
    (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (i.prototype.thumbnail = function (e, t) {
        ...
        "youtube" === t.type
          ? ((r = "//img.youtube.com/vi/" + t.id + "/hqdefault.jpg"), i(r))
          : "vimeo" === t.type
          ? u.ajax({
              type: "GET",
  ...
  (function (o) {
    ...
    (e.Defaults = { animateOut: !1, animateIn: !1 }),
      ...
      (o.fn.owlCarousel.Constructor.Plugins.Animate = e);
  })(window.Zepto || window.jQuery, (window, document)),
  (function (n, r, e) {
    var i = function (t) {
      (this._core = t),
  ...
  (function (r, s) {
    ...
    !(function () {
      ...
      ((r.support.transition = new String(t("transition"))),
      (r.support.transition.end = i.transition.end[r.support.transition])),
      h() &&
        ((r.support.animation = new String(t("animation"))),
        (r.support.animation.end = i.animation.end[r.support.animation])),
      n() &&
        ((r.support.transform = new String(t("transform"))),
        (r.support.transform3d = l()));
