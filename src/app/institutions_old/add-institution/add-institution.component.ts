...
export class AddInstitutionComponent implements AfterViewInit {
  ...
  @Output() save: EventEmitter<InstitutionsInterface> = new EventEmitter<
  ...
  ngAfterViewInit() {
    this.institutionForm = this.fb.group({
      institutionName: [
        this.institution ? this.institution.institutionName : "",
        [Validators.required],
      ],
      contactPerson: [
        this.institution ? this.institution.contactPerson : "",
        [Validators.required],
      ],
      address: [
        this.institution ? this.institution.address : "",
        [Validators.required],
      ],
      contactEmail: [
        this.institution ? this.institution.contactEmail : "",
        [Validators.required],
      ],
      institutionId: [
      ...
      contactPhone: [
        this.institution ? this.institution.contactPhone : "",
        [
          Validators.required,
          Validators.pattern(
      ...
      memberShip: [
        this.institution ? this.institution.memberShip : "",
        [Validators.required],
      ],
      status: [
        this.institution ? this.institution.status : "",
        [Validators.required],
      ],
    });
    setTimeout(() => {
  ...
  async onSubmit() {
    if (this.institution) {
      ...
      await this.institutionsService.updateInstitutions(
        this.institutionForm.value,
        this.institution.id,
        this.institution.createdOn
      );
      this.showForm = false;
      ...
      const busyIndicatorId = this.busyIndicator.show();
      await this.institutionsService.addInstitutions(
        this.institutionForm.value
      );
      this.showForm = false;
      this.institutionForm.reset();
