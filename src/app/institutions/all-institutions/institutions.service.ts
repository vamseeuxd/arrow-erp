...
export class InstitutionsService {
  ...
  private institutionsCollection: AngularFirestoreCollection<InstitutionsInterface>;
  ...
  updateInstitutions(institution: InstitutionsInterface, id: string, createdOn: any): Promise<any> {
    return new Promise(
      async function(resolve, reject) {
        try {
